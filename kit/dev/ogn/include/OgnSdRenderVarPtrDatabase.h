...
std::tuple<int, int, int> OgnSdRenderVarPtrDatabase::sm_generatorVersionOgnSdRenderVarPtr{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdRenderVarPtrDatabase::sm_targetVersionOgnSdRenderVarPtr{std::make_tuple(2,184,5)};
}
