...
std::tuple<int, int, int> OgnSdPostRenderVarTextureToBufferDatabase::sm_generatorVersionOgnSdPostRenderVarTextureToBuffer{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdPostRenderVarTextureToBufferDatabase::sm_targetVersionOgnSdPostRenderVarTextureToBuffer{std::make_tuple(2,184,5)};
}
