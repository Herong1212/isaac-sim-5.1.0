...
std::tuple<int, int, int> OgnSdPostRenderVarToHostDatabase::sm_generatorVersionOgnSdPostRenderVarToHost{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdPostRenderVarToHostDatabase::sm_targetVersionOgnSdPostRenderVarToHost{std::make_tuple(2,184,5)};
}
