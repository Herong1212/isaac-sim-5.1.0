...
std::tuple<int, int, int> OgnSdPostSemanticFilterSegmentationMapDatabase::sm_generatorVersionOgnSdPostSemanticFilterSegmentationMap{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdPostSemanticFilterSegmentationMapDatabase::sm_targetVersionOgnSdPostSemanticFilterSegmentationMap{std::make_tuple(2,184,5)};
