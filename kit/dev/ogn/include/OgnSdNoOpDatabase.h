...
std::tuple<int, int, int> OgnSdNoOpDatabase::sm_generatorVersionOgnSdNoOp{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdNoOpDatabase::sm_targetVersionOgnSdNoOp{std::make_tuple(2,184,5)};
}
