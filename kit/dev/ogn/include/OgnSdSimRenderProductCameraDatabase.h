...
std::tuple<int, int, int> OgnSdSimRenderProductCameraDatabase::sm_generatorVersionOgnSdSimRenderProductCamera{std::make_tuple(1,79,2)};
std::tuple<int, int, int> OgnSdSimRenderProductCameraDatabase::sm_targetVersionOgnSdSimRenderProductCamera{std::make_tuple(2,184,5)};
}
