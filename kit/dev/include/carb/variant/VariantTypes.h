 ...
 *     * Can be converted to \ref omni::string or `std::string` as if by \ref dictionary::IDictionary::getStringBuffer()
 *       or if that fails, \ref dictionary::IDictionary::createStringBufferFromItemName().
