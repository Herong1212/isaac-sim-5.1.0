...
struct OptionalDestructor
{
    ...
    template <class... Args>
    constexpr explicit OptionalDestructor(std::in_place_t, Args&&... args)
...
using SelectCopy = typename std::conditional_t<
    std::conjunction<std::is_copy_constructible<Types>...,
                     std::negation<std::conjunction<std::is_trivially_copy_constructible<Types>...>>>::value,
    NonTrivialCopy<Base>,
    Base>;
...
template <class Base, class... Types>
using SelectMove = typename std::conditional_t<
    std::conjunction<std::is_move_constructible<Types>...,
                     std::negation<std::conjunction<std::is_trivially_move_constructible<Types>...>>>::value,
...
using SelectCopyAssign = typename std::conditional_t<
    std::conjunction<std::is_trivially_destructible<Types>...,
                     std::is_trivially_copy_constructible<Types>...,
                     std::is_trivially_copy_assignable<Types>...>::value,
    SelectMove<Base, Types...>,
    typename std::conditional_t<std::conjunction<std::is_copy_constructible<Types>..., std::is_copy_assignable<Types>...>::value,
...
using SelectMoveAssign = typename std::conditional_t<
    ...
    typename std::conditional_t<std::conjunction<std::is_move_constructible<Types>..., std::is_move_assignable<Types>...>::value,
