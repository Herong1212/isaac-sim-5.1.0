...
.. _ext_isaacsim_replicator_mobility_gen:
...
[isaacsim.replicator.mobility_gen] MobilityGen
##############################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.replicator.mobility_gen
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.replicator.mobility_gen``.
