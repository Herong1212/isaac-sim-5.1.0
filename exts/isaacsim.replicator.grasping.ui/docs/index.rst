...
.. _ext_isaacsim_replicator_grasping_ui:
...
[isaacsim.replicator.grasping.ui] Replicator Grasping Pipeline UI
#################################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.replicator.grasping.ui
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.replicator.grasping.ui``.
