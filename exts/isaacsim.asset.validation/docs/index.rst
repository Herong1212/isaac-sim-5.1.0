...
.. _ext_isaacsim_asset_validation:
...
.. tab-set::
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.asset.validation``.
