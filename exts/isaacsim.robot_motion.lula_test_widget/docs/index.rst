...
.. _ext_isaacsim_robot_motion_lula_test_widget:
...
[isaacsim.robot_motion.lula_test_widget] Lula Test Widget
#########################################################
...
.. tab-set::
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.robot_motion.lula_test_widget``.
