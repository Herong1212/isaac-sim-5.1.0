r"""Support for simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2RtxLidarHelper
...
class OgnROS2RtxLidarHelperDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2RtxLidarHelper
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.ros2.bridge.ROS2RtxLidarHelper'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnROS2RtxLidarHelperDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.ros2.bridge.ROS2RtxLidarHelper.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.ros2.bridge.ROS2RtxLidarHelper")
