r"""Support for simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2CameraInfoHelper
...
class OgnROS2CameraInfoHelperDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2CameraInfoHelper
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.ros2.bridge.ROS2CameraInfoHelper'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnROS2CameraInfoHelperDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.ros2.bridge.ROS2CameraInfoHelper.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.ros2.bridge.ROS2CameraInfoHelper")
