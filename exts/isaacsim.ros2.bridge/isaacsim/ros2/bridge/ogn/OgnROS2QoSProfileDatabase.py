r"""Support for simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2QoSProfile
...
class OgnROS2QoSProfileDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2QoSProfile
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.ros2.bridge.ROS2QoSProfile'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnROS2QoSProfileDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.ros2.bridge.ROS2QoSProfile.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.ros2.bridge.ROS2QoSProfile")
