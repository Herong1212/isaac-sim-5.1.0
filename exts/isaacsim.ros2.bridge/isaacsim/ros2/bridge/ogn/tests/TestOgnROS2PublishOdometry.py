...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        ...
        test_node = og.Controller.node("/TestGraph/Template_isaacsim_ros2_bridge_ROS2PublishOdometry")
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:publishRawVelocities"))
        attribute = test_node.get_attribute("inputs:publishRawVelocities")
        self.assertTrue(attribute.is_valid())
