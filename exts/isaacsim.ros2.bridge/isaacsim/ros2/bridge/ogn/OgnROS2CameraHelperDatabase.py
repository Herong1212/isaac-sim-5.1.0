r"""Support for simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2CameraHelper
...
class OgnROS2CameraHelperDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type isaacsim.ros2.bridge.ROS2CameraHelper
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:type', 'token', 0, None, 'type', {ogn.MetadataKeys.ALLOWED_TOKENS: 'rgb,depth,depth_pcl,instance_segmentation,semantic_segmentation,bbox_2d_tight,bbox_2d_loose,bbox_3d', ogn.MetadataKeys.ALLOWED_TOKENS_RAW: '{"rgb": "rgb", "depth": "depth", "depth_pcl": "depth_pcl", "instance_segmentation": "instance_segmentation", "semantic_segmentation": "semantic_segmentation", "bbox_2d_tight": "bbox_2d_tight", "bbox_2d_loose": "bbox_2d_loose", "bbox_3d": "bbox_3d"}', ogn.MetadataKeys.DEFAULT: '"rgb"'}, True, "rgb", False, ''),
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'isaacsim.ros2.bridge.ROS2CameraHelper'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnROS2CameraHelperDatabase.abi.initialize(context, n)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                node_type.set_metadata(ogn.MetadataKeys.EXTENSION, "isaacsim.ros2.bridge")
                ...
                icon_path = carb.tokens.get_tokens_interface().resolve("${isaacsim.ros2.bridge}")
                icon_path = icon_path + '/' + "ogn/icons/isaacsim.ros2.bridge.ROS2CameraHelper.svg"
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("isaacsim.ros2.bridge.ROS2CameraHelper")
