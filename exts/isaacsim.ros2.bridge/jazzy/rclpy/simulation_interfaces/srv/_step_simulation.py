...
class Metaclass_StepSimulation_Event(type):
    """Metaclass of message 'StepSimulation_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__step_simulation__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__step_simulation__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__step_simulation__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__step_simulation__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__step_simulation__event
...
class StepSimulation_Event(metaclass=Metaclass_StepSimulation_Event):
    """Message class 'StepSimulation_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simulation_interfaces/StepSimulation_Request, 1>',
        'response': 'sequence<simulation_interfaces/StepSimulation_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'StepSimulation_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'StepSimulation_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import StepSimulation_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, StepSimulation_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'StepSimulation_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import StepSimulation_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, StepSimulation_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'StepSimulation_Response'"
...
class Metaclass_StepSimulation(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _step_simulation.Metaclass_StepSimulation_Event._TYPE_SUPPORT is None:
                _step_simulation.Metaclass_StepSimulation_Event.__import_type_support__()
...
class StepSimulation(metaclass=Metaclass_StepSimulation):
    ...
    from simulation_interfaces.srv._step_simulation import StepSimulation_Event as Event
