...
class Metaclass_SetEntityState_Event(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simulation_interfaces.srv.SetEntityState_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SetEntityState_Event(metaclass=Metaclass_SetEntityState_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simulation_interfaces/SetEntityState_Request, 1>',
        'response': 'sequence<simulation_interfaces/SetEntityState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'SetEntityState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'SetEntityState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import SetEntityState_Request
    ...
    def response(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import SetEntityState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetEntityState(metaclass=Metaclass_SetEntityState):
    ...
    from simulation_interfaces.srv._set_entity_state import SetEntityState_Event as Event
