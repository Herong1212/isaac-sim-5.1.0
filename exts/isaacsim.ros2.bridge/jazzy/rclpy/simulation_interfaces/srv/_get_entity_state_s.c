...
ROSIDL_GENERATOR_C_EXPORT
bool simulation_interfaces__srv__get_entity_state__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.srv._get_entity_state.GetEntityState_Event", full_classname_dest, 64) == 0);
  }
  simulation_interfaces__srv__GetEntityState_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!simulation_interfaces__srv__GetEntityState_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create simulation_interfaces__srv__GetEntityState_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    simulation_interfaces__srv__GetEntityState_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!simulation_interfaces__srv__get_entity_state__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!simulation_interfaces__srv__GetEntityState_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create simulation_interfaces__srv__GetEntityState_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    simulation_interfaces__srv__GetEntityState_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!simulation_interfaces__srv__get_entity_state__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * simulation_interfaces__srv__get_entity_state__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    simulation_interfaces__srv__GetEntityState_Request * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = simulation_interfaces__srv__get_entity_state__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    simulation_interfaces__srv__GetEntityState_Response * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = simulation_interfaces__srv__get_entity_state__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
