...
class Metaclass_GetEntitiesStates_Event(type):
    """Metaclass of message 'GetEntitiesStates_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simulation_interfaces.srv.GetEntitiesStates_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_entities_states__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_entities_states__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_entities_states__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_entities_states__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_entities_states__event
...
class GetEntitiesStates_Event(metaclass=Metaclass_GetEntitiesStates_Event):
    """Message class 'GetEntitiesStates_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simulation_interfaces/GetEntitiesStates_Request, 1>',
        'response': 'sequence<simulation_interfaces/GetEntitiesStates_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'GetEntitiesStates_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'GetEntitiesStates_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import GetEntitiesStates_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetEntitiesStates_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetEntitiesStates_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import GetEntitiesStates_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetEntitiesStates_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetEntitiesStates_Response'"
...
class Metaclass_GetEntitiesStates(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_entities_states.Metaclass_GetEntitiesStates_Event._TYPE_SUPPORT is None:
                _get_entities_states.Metaclass_GetEntitiesStates_Event.__import_type_support__()
...
class GetEntitiesStates(metaclass=Metaclass_GetEntitiesStates):
    ...
    from simulation_interfaces.srv._get_entities_states import GetEntitiesStates_Event as Event
