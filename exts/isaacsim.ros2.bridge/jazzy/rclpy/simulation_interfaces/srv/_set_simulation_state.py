...
class Metaclass_SetSimulationState_Event(type):
    """Metaclass of message 'SetSimulationState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simulation_interfaces.srv.SetSimulationState_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_simulation_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_simulation_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_simulation_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_simulation_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_simulation_state__event
...
class SetSimulationState_Event(metaclass=Metaclass_SetSimulationState_Event):
    """Message class 'SetSimulationState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simulation_interfaces/SetSimulationState_Request, 1>',
        'response': 'sequence<simulation_interfaces/SetSimulationState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'SetSimulationState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'SetSimulationState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import SetSimulationState_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetSimulationState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetSimulationState_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import SetSimulationState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetSimulationState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetSimulationState_Response'"
...
class Metaclass_SetSimulationState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_simulation_state.Metaclass_SetSimulationState_Event._TYPE_SUPPORT is None:
                _set_simulation_state.Metaclass_SetSimulationState_Event.__import_type_support__()
...
class SetSimulationState(metaclass=Metaclass_SetSimulationState):
    ...
    from simulation_interfaces.srv._set_simulation_state import SetSimulationState_Event as Event
