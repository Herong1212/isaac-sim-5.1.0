...
class Metaclass_GetEntityState_Event(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simulation_interfaces.srv.GetEntityState_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GetEntityState_Event(metaclass=Metaclass_GetEntityState_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<simulation_interfaces/GetEntityState_Request, 1>',
        'response': 'sequence<simulation_interfaces/GetEntityState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'GetEntityState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['simulation_interfaces', 'srv'], 'GetEntityState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import GetEntityState_Request
    ...
    def response(self, value):
        if self._check_fields:
            from simulation_interfaces.srv import GetEntityState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetEntityState(metaclass=Metaclass_GetEntityState):
    ...
    from simulation_interfaces.srv._get_entity_state import GetEntityState_Event as Event
