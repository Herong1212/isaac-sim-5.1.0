...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:azimuthBufferSize"))
        attribute = test_node.get_attribute("inputs:azimuthBufferSize")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:azimuthDataType"))
        attribute = test_node.get_attribute("inputs:azimuthDataType")
        self.assertTrue(attribute.is_valid())
        expected_value = 4
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:azimuthPtr"))
        attribute = test_node.get_attribute("inputs:azimuthPtr")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:distanceBufferSize"))
        attribute = test_node.get_attribute("inputs:distanceBufferSize")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:distanceDataType"))
        attribute = test_node.get_attribute("inputs:distanceDataType")
        self.assertTrue(attribute.is_valid())
        expected_value = 4
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:distancePtr"))
        attribute = test_node.get_attribute("inputs:distancePtr")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:intensityBufferSize"))
        attribute = test_node.get_attribute("inputs:intensityBufferSize")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:intensityDataType"))
        attribute = test_node.get_attribute("inputs:intensityDataType")
        self.assertTrue(attribute.is_valid())
        expected_value = 4
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:intensityPtr"))
        attribute = test_node.get_attribute("inputs:intensityPtr")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))

        self.assertTrue(test_node.get_attribute_exists("inputs:metaDataPtr"))
        attribute = test_node.get_attribute("inputs:metaDataPtr")
        self.assertTrue(attribute.is_valid())
        expected_value = 0
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
