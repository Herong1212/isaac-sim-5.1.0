...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        ...
        self.assertTrue(test_node.get_attribute_exists("outputs:globalLinearAcceleration"))
        attribute = test_node.get_attribute("outputs:globalLinearAcceleration")
        self.assertTrue(attribute.is_valid())

        self.assertTrue(test_node.get_attribute_exists("outputs:globalLinearVelocity"))
        attribute = test_node.get_attribute("outputs:globalLinearVelocity")
        self.assertTrue(attribute.is_valid())
