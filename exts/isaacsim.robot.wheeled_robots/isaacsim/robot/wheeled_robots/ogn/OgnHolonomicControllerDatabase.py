r"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.HolonomicController
...
class OgnHolonomicControllerDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:inputVelocity', 'double3', 0, 'Velocity Commands for the vehicle', 'Velocity in x and y (m/s) and rotation (rad/s)', {}, True, [0.0, 0.0, 0.0], False, ''),
        ('inputs:linearGain', 'double', 0, None, 'Linear gain', {ogn.MetadataKeys.DEFAULT: '1'}, True, 1, False, ''),
        ('inputs:maxAngularSpeed', 'double', 0, None, 'Maximum angular rotation speed allowed for the vehicle in rad/s', {ogn.MetadataKeys.DEFAULT: '100000'}, False, 100000, False, ''),
        ('inputs:maxLinearSpeed', 'double', 0, None, 'Maximum speed allowed for the vehicle in m/s', {ogn.MetadataKeys.DEFAULT: '100000'}, False, 100000, False, ''),
        ('inputs:maxWheelSpeed', 'double', 0, None, 'Maximum rotation speed allowed for the wheel joints in rad/s', {ogn.MetadataKeys.DEFAULT: '100000'}, False, 100000, False, ''),
        ('inputs:mecanumAngles', 'double[]', 0, None, "Angles of the mecanum wheels with respect to wheel's rotation axis in radians", {}, True, [], False, ''),
        ...
        ('inputs:wheelPositions', 'double3[]', 0, None, "Position of the wheel with respect to chassis' center of mass in meters", {}, True, [], False, ''),
        ('inputs:wheelRadius', 'double[]', 0, None, 'An array of wheel radius in meters', {}, True, [], False, ''),
    ...
    class abi:
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                node_type.set_metadata(ogn.MetadataKeys.CATEGORIES, "isaacWheeledRobots")
                node_type.set_metadata(ogn.MetadataKeys.CATEGORY_DESCRIPTIONS, "isaacWheeledRobots,robot controller inside Isaac Sim")
