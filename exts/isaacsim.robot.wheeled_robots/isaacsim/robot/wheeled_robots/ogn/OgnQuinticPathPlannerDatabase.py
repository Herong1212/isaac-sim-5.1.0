r"""Support for simplified access to data on nodes of type isaacsim.robot.wheeled_robots.QuinticPathPlanner
    ...
    class abi:
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                node_type.set_metadata(ogn.MetadataKeys.CATEGORY_DESCRIPTIONS, "isaacWheeledRobots,robot path planning inside Isaac Sim")
