...
.. _ext_isaacsim_replicator_mobility_gen_ui:
...
[isaacsim.replicator.mobility_gen.ui] MobilityGen UI
####################################################
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.replicator.mobility_gen.ui
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.replicator.mobility_gen.ui``.
