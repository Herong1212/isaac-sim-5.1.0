...
.. _ext_isaacsim_asset_importer_urdf:
...
.. tab-set::
    ...
    .. tab-item:: Extension Manager UI
        ...
        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.asset.importer.urdf``.
...
.. list-table::
    ...
    * - Application/extension setting
      - Description
      - Value
    * - ``exts."omni.kit.window.filepicker".detail_width_init``
      - Set the initial width of the file picker to 390

      - ``390``
    * - ``exts."omni.kit.window.filepicker".detail_width_min``
      - Set the minimum width of the file picker to 390

      - ``390``
    * - ``exts."omni.kit.window.filepicker".detail_width_max``
