...
from .visualization_manipulator import VisualizationManipulator
from .visualization_model import VisualizationModel


class ViewportScene:
    """The Visualization Manipulator, placed into a Viewport"""
    ...
    def __init__(self, viewport_window: ui.Window, ext_id: str) -> None:
        ...
        with self._viewport_window.get_frame(ext_id):
            ...
            with self._scene_view.scene:
                self._manipulator = VisualizationManipulator(model=VisualizationModel())
