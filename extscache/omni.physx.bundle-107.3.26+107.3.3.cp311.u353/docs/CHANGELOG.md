...
**General**
    ...
    - Added
        ...
        - A joint parameter tuning example for a specific gripper has been added to the Omniverse Physics Developer Guide.

    - Fixed

        - Fixed interaction of deformables with non-root articulation links
...
**General**
    ...
    - Fixed
        ...
        - Fixed a crash when FabricParticles::update() is called but mFabricParticles is nullptr
        - Implement correct synchronization for deformable skinning

**TensorAPI**

    - Fixed

        - Fixes tensor API rigid-body and articulation setInertia methods. The setters were not setting the principal axis correctly, leading to incorrect inertias set on links and bodies in case inertial and body frames were not aligned.
