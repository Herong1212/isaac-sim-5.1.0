...
class CustomLayout(ogui.PrimPathCustomLayoutBase):
    """Custom layout for ReadPrimMaterial node
    ...
    def apply(self, props):
        ...
        with frame:
            with CustomLayoutGroup("Inputs"):
                ...
                if prop:
                    CustomLayoutProperty(prop.prop_name, "Prims Bundle")
            ...
            with CustomLayoutGroup("Outputs"):
                prop = self._find_prop(props, "outputs:materialPrim")
                if prop:
                    CustomLayoutProperty(prop.prop_name, "Material")

                prop = self._find_prop(props, "outputs:material")
                if prop:
                    CustomLayoutProperty(prop.prop_name, "Material Path")
