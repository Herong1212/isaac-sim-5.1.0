...
from omni.graph.nodes._impl.omnigraph_transform_node_templates import RotationNodeCustomLayoutBase
from omni.kit.property.usd.custom_layout_helper import CustomLayoutFrame, CustomLayoutGroup, CustomLayoutProperty


class CustomLayout(RotationNodeCustomLayoutBase):
    """Custom layout for GetMatrix4RotationMatrix node
    ...
    def apply(self, props):
        ...
        with frame:
            ...
            with CustomLayoutGroup("Outputs"):
                prop = ogui.find_prop(props, "outputs:rotation")
                if prop:
