...
#include <OgnArrayReverseDatabase.h>
...
size_t tryComputeAssumingType(OgnArrayReverseDatabase& db, size_t count)
{
    for (size_t idx = 0; idx < count; ++idx)
    {
        ...
        if (inputArray && outputArray)
        {
            ...
            std::reverse(outputArray->begin(), outputArray->end());
        }
    }
    return count;
}
...
class OgnArrayReverse
{
public:
    static size_t computeVectorized(OgnArrayReverseDatabase& db, size_t count)
    {
        try
        {
