...
#include <OgnTransposeDatabase.h>
...
size_t tryComputeAssumingType(OgnTransposeDatabase& db, size_t count)
{
...
{
public:
    static size_t computeVectorized(OgnTransposeDatabase& db, size_t count)
    {
