...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    TEST_DATA = [
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'double[]', 'value': [11, 17]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[2][]', 'value': [[3, 4], [5, 6]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[2][]', 'value': [[1, 2], [1, 2]]}, False],
                    ['inputs:b', {'type': 'double[2][]', 'value': [[3, 4], [5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'double[]', 'value': [11, 17]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[3]', 'value': [1, 2, 3]}, False],
                    ['inputs:b', {'type': 'double[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'double[]', 'value': [14, 32]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[3][]', 'value': [[1, 2, 3], [1, 2, 3]]}, False],
                    ['inputs:b', {'type': 'double[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'double[]', 'value': [14, 32]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ...
                    ['inputs:b', {'type': 'double[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'double[]', 'value': [30, 70]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'double[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'float', 'value': 11}, False],
                ],
            },
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'float[]', 'value': [11, 17]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[2][]', 'value': [[3, 4], [5, 6]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[2][]', 'value': [[1, 2], [1, 2]]}, False],
                    ['inputs:b', {'type': 'float[2][]', 'value': [[3, 4], [5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'float[]', 'value': [11, 17]}, False],
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'float', 'value': 32}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[3]', 'value': [1, 2, 3]}, False],
                    ['inputs:b', {'type': 'float[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'float[]', 'value': [14, 32]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'float', 'value': 70}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[4]', 'value': [1, 2, 3, 4]}, False],
                    ['inputs:b', {'type': 'float[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'float[]', 'value': [30, 70]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'float[4][]', 'value': [[1, 2, 3, 4], [1, 2, 3, 4]]}, False],
                    ['inputs:b', {'type': 'float[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'float[]', 'value': [30, 70]}, False],
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'half', 'value': 11}, False],
                ],
            },
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [11, 17]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[2][]', 'value': [[3, 4], [5, 6]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[2][]', 'value': [[1, 2], [1, 2]]}, False],
                    ['inputs:b', {'type': 'half[2][]', 'value': [[3, 4], [5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [11, 17]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[3]', 'value': [1, 2, 3]}, False],
                    ['inputs:b', {'type': 'half[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [14, 32]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[3][]', 'value': [[1, 2, 3], [1, 2, 3]]}, False],
                    ['inputs:b', {'type': 'half[3][]', 'value': [[1, 2, 3], [4, 5, 6]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [14, 32]}, False],
        ...
        },
        {
            '': {
                ...
                'outputs': [
                    ['outputs:product', {'type': 'half', 'value': 70}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[4]', 'value': [1, 2, 3, 4]}, False],
                    ['inputs:b', {'type': 'half[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [30, 70]}, False],
                ],
            },
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
        ...
        },
        {
            '': {
                'inputs': [
                    ['inputs:a', {'type': 'half[4][]', 'value': [[1, 2, 3, 4], [1, 2, 3, 4]]}, False],
                    ['inputs:b', {'type': 'half[4][]', 'value': [[1, 2, 3, 4], [5, 6, 7, 8]]}, False],
                ],
                'outputs': [
                    ['outputs:product', {'type': 'half[]', 'value': [30, 70]}, False],
    ...
    async def test_generated(self):
        for i, test_run in enumerate(self.TEST_DATA):
            ...
            test_info = await _test_setup_scene(self, controller, f"/TestGraph{i}", "TestNode_omni_graph_nodes_DotProduct", "omni.graph.nodes.DotProduct", test_run, _TestGraphAndNode())
    ...
    async def test_vectorized_generated(self):
        for i, test_run in enumerate(self.TEST_DATA):
            ...
            controller = og.Controller()
            await _test_clear_scene(self, test_run, reset_stage=False)
            test_info = await _test_setup_scene(self, controller, f"/TestGraph{i}", "TestNode_omni_graph_nodes_DotProduct","omni.graph.nodes.DotProduct", test_run, _TestGraphAndNode(), 16)
            await controller.evaluate(test_info.graph)
    ...
    async def test_thread_safety(self):
        ...
        for (key, test_info) in instance_setup.copy().items():
            instance_setup[key] = await _test_setup_scene(self, og.Controller(allow_exists_prim=True), key, "TestNode_omni_graph_nodes_DotProduct", "omni.graph.nodes.DotProduct", test_data_setup[key], test_info)
        ...
        for (key, test_info) in instance_setup.items():
            _test_verify_scene(self, og.Controller(), test_data_setup[key], test_info, f"omni.graph.nodes.DotProduct User test case instance{key}")
