.. _omni_graph_nodes_ConstantTexCoord3f_1:
...
Container for a 3-component single-precision floating-point UVW texture coordinate value, mainly used to share a common value between several downstream nodes.
