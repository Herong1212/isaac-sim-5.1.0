.. _omni_graph_nodes_ConstantFloat_1:
...
Container for a single-precision floating-point value, mainly used to share a common value between several downstream nodes.
