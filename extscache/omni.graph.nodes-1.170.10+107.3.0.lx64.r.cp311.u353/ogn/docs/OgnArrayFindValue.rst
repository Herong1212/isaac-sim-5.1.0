.. _omni_graph_nodes_ArrayFindValue_1:
...
.. csv-table::
    ...
    "Index (*outputs:index*)", "``int``", "The index of the first occurrence of ""Value"" in ""Array"", or -1 if no instances of ""Value"" are found in ""Array"".", "None"
