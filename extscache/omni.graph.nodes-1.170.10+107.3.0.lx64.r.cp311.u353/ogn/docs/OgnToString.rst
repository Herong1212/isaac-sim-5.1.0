...
Converts the input to a string representation. Array inputs are converted to a single output string.
...
.. csv-table::
    ...
    "String (*outputs:converted*)", "``string``", "The input value represented as a string.", "None"
