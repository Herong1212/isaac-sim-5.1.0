...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        test_file_name = "OgnTagPrimsFromRampTemplate.usda"
        usd_path = os.path.join(os.path.dirname(__file__), "usd", test_file_name)
        if not os.path.exists(usd_path):  # pragma: no cover
            self.assertTrue(False, f"{usd_path} not found for loading test")
        (result, error) = await ogts.load_test_file(usd_path)
        self.assertTrue(result, f'{error} on {usd_path}')
        test_node = og.Controller.node("/TestGraph/Template_omni_genproc_core_TagPrimsFromRamp")
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:rampInterpolations"))
        attribute = test_node.get_attribute("inputs:rampInterpolations")
        self.assertTrue(attribute.is_valid())
        expected_value = [1, 1]
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:rampPositions"))
        attribute = test_node.get_attribute("inputs:rampPositions")
        self.assertTrue(attribute.is_valid())
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:rampTags"))
        attribute = test_node.get_attribute("inputs:rampTags")
        self.assertTrue(attribute.is_valid())
        expected_value = ['run', 'walk', 'idle']
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:rampValues"))
        attribute = test_node.get_attribute("inputs:rampValues")
        self.assertTrue(attribute.is_valid())
        ...
        self.assertTrue(test_node.get_attribute_exists("state:prevRampInterpolations"))
        attribute = test_node.get_attribute("state:prevRampInterpolations")
        self.assertTrue(attribute.is_valid())
        ...
        self.assertTrue(test_node.get_attribute_exists("state:prevRampPositions"))
        attribute = test_node.get_attribute("state:prevRampPositions")
        self.assertTrue(attribute.is_valid())
        ...
        self.assertTrue(test_node.get_attribute_exists("state:prevRampTags"))
        attribute = test_node.get_attribute("state:prevRampTags")
        self.assertTrue(attribute.is_valid())
        ...
        self.assertTrue(test_node.get_attribute_exists("state:prevRampValues"))
        attribute = test_node.get_attribute("state:prevRampValues")
        self.assertTrue(attribute.is_valid())
