...
This extension contains precompiled Vulkan shader caches for omni.hydra.rtx renderers, and upon loading it will add them to the search path of shaderDb.
Without shader caches, hydra.rtx renderers are not able to continue.
