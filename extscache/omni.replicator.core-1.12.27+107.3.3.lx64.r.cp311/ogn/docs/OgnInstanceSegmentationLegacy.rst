.. _omni_replicator_core_InstanceSegmentationLegacy_1:

.. _omni_replicator_core_InstanceSegmentationLegacy:
...
.. meta::
    :title: Instance Segmentation Legacy
    :keywords: lang-en omnigraph node Replicator core instance-segmentation-legacy


Instance Segmentation Legacy
============================
...
.. csv-table::
    ...
    "Data (*outputs:data*)", "``uchar[]``", "Instance segmentation data", "[]"
    ...
    "Id To Semantics (*outputs:idToSemantics*)", "``string``", "Mapping from id to semantic labels.", "None"
...
.. csv-table::
    ...
    "Unique ID", "omni.replicator.core.InstanceSegmentationLegacy"
    "Version", "1"
    ...
    "__categoryDescriptions", "Replicator,Instance segmentation Legacy"
    "Generated Class Name", "OgnInstanceSegmentationLegacyDatabase"
