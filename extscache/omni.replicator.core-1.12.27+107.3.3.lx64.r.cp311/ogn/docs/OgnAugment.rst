.. _omni_replicator_core_OgnAugment_1:

.. _omni_replicator_core_OgnAugment:
...
.. meta::
    :title: Augment
    :keywords: lang-en omnigraph node Replicator:Annotators core ogn-augment
...
.. csv-table::
    ...
    "Data (*inputs:data*)", "``uchar[]``", "Input data", "[]"
    "Data Out Shape (*inputs:dataOutShape*)", "``int[]``", "Desired dimensions of output array", "[]"
    ...
    "Data Type (*inputs:dataType*)", "``token``", "Defines the data type", "uint8"
...
.. csv-table::
    ...
    "Unique ID", "omni.replicator.core.OgnAugment"
    "Version", "1"
    ...
    "Generated Class Name", "OgnAugmentDatabase"
