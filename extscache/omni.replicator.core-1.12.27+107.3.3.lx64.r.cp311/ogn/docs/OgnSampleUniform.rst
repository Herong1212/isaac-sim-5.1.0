.. _omni_replicator_core_OgnSampleUniform_1:

.. _omni_replicator_core_OgnSampleUniform:
...
.. meta::
    ...
    :keywords: lang-en omnigraph node Replicator:Core compute-on-request core ogn-sample-uniform
...
.. csv-table::
    ...
    "Lower (*inputs:lower*)", "``float[]``", "the lower bound of the uniform distribution", "[]"
    ...
    "Upper (*inputs:upper*)", "``float[]``", "the upper bound of the uniform distribution", "[]"
...
.. csv-table::
    ...
    "Unique ID", "omni.replicator.core.OgnSampleUniform"
    "Version", "1"
