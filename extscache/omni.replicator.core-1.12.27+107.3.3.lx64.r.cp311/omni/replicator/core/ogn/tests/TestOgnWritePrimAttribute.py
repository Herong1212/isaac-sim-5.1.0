...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.replicator.core.ogn.OgnWritePrimAttributeDatabase import OgnWritePrimAttributeDatabase
        ...
        test_node = og.Controller.node("/TestGraph/Template_omni_replicator_core_OgnWritePrimAttribute")
        ...
        self.assertTrue(test_node.get_attribute_exists("inputs:attributeType"))
        attribute = test_node.get_attribute("inputs:attributeType")
        self.assertTrue(attribute.is_valid())
        db_value = database.inputs.attributeType
        database.inputs.attributeType = db_value
        expected_value = ""
        actual_value = og.Controller.get(attribute)
        ogts.verify_values(expected_value, actual_value, _attr_error(attribute, True))
        ogts.verify_values(expected_value, db_value, _attr_error(attribute, False))
