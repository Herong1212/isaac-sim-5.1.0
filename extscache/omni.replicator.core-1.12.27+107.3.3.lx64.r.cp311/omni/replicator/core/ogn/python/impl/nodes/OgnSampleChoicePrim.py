...
class OgnSampleChoicePrimInternalState:
    def __init__(self):
        self.rng = rep.rng.ReplicatorRNG()


class OgnSampleChoicePrim:
    @staticmethod
    def internal_state():
        return OgnSampleChoicePrimInternalState()
    ...
    def compute(db) -> bool:
        ...
        db.outputs.samples = samples.tolist()
        db.outputs.prims = samples.tolist()
