...
class TestControllerModelsAndTooltipsVR(XRTestVR):
    ...
    async def test_unit_controller_models_vr(self):
        """Launch VR controllers and tooltips"""
        ...
        async with TestVRUIProfile(self):
            ...
            await self.capture_and_compare_stereo_output_async(
                "dual_meta_touch_controller_and_tooltips_quest2", 0.001, golden_image_source
            )
            ...
            await self.capture_and_compare_stereo_output_async(
                "dual_vive_controller_and_tooltips", 0.001, golden_image_source
            )
            ...
            # await self.capture_and_compare_stereo_output_async(
            #     "dual_vive_cosmos_controller_and_tooltips", 0.001, golden_image_source
            # )
            ...
            await self.capture_and_compare_stereo_output_async(
                "dual_vive_focus3_controller_and_tooltips", 0.001, golden_image_source
            )
            ...
            # await self.capture_and_compare_stereo_output_async(
            #     "dual_valve_index_controller_and_tooltips", 0.001, golden_image_source
            # )
            ...
            await self.capture_and_compare_stereo_output_async(
                "dual_meta_touch_controller_and_tooltips_quest2_z_up", 0.001, golden_image_source
            )
            ...
            await self.capture_and_compare_stereo_output_async(
                "dual_vive_focus3_controller_and_tooltips_z_up", 0.001, golden_image_source
            )
