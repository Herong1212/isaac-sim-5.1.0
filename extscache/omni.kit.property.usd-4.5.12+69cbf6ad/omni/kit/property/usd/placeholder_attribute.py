...
class PlaceholderAttribute:
    ...
    def Get(self, time_code=0):  # noqa: N802  # pylint: disable=invalid-name
        ...
        carb.log_warn(
            f"PlaceholderAttribute.Get() customData.default or default not found in metadata for property: '{self._name}' on prim: '{self._prim.GetPath()}'"
        )
        return None

    def GetPath(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        if self._prim:
            return self._prim.GetPath()
        return None

    def ValueMightBeTimeVarying(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return False

    def GetMetadata(self, token):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        if token in self._metadata:
            return self._metadata[token]
        return False

    def GetAllMetadata(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return self._metadata

    def GetPrim(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return self._prim

    def GetName(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return self._name

    def GetDisplayGroup(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return ""

    def CreateAttribute(self):  # noqa: N802  # pylint: disable=invalid-name
    ...
    def HasAuthoredConnections(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return False

    def IsHidden(self):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return False

    def GetPropertyStack(self, *args, **kwargs):  # noqa: N802  # pylint: disable=invalid-name
        """Mock Usd.Attribute function"""
        return []
