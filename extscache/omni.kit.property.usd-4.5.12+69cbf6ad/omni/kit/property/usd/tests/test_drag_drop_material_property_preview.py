...
class DragDropMaterialPropertyPreview(AsyncTestCase):
    ...
    async def test_drag_drop_material_property_preview(self, retry_count=0):
                ...
                async with MaterialLibraryTestHelper() as material_test_helper:
                    try:
                        ...
                        if retry_count < 5:
                            ...
                            return await self.test_drag_drop_material_property_preview(retry_count + 1)
                        raise de
