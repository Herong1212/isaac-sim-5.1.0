...
class ProgressPopup:
    ...
    def centre_in_window(self, widget):
        width = self._popup.frame.computed_width or 392
        height = self._popup.frame.computed_height or 95
        self._popup.position_x = ((widget.computed_width - width)/2) + widget.screen_position_x
        self._popup.position_y = ((widget.computed_height - height)/2) + widget.screen_position_y
