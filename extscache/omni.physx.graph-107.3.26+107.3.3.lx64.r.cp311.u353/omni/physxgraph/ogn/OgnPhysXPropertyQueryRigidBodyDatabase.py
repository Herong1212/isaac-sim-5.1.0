r"""Support for simplified access to data on nodes of type omni.physx.graph.PropertyQueryRigidBody
...
class OgnPhysXPropertyQueryRigidBodyDatabase(og.Database):
    ...
    class abi:
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnPhysXPropertyQueryRigidBodyDatabase.abi.initialize(context, n)
