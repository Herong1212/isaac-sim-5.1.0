...
class CustomCommandTemplate(Enum):
    ...
    TIMING_TO_OBJECT = "TimingToObject"  # Command will go to the given object and play anim for given seconds
    GOTO_BLEND = "GoToBlend"  # Command that blends an animation into default GoTo (with a filter joint)
