...
class TalkWith(Command):
    ...
    def get_valid_talk_position(self, target_character_name):
        ...
        ##communicating_point
        talking_position = Utils.get_closest_navmesh_point(self.find_point(start_point, end_point))
    ...
    def update(self, dt):
        ...
        if self.current_action == "rotate_to_target" or self.current_action == None:
