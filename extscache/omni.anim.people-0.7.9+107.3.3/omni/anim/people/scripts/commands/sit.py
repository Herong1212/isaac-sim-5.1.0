...
from omni.anim.people.settings import TaskStatus
...
class Sit(Command):
    ...
    def set_command_description_usage(cls):
        ...
        cls.command_description = "Moves the character to a target object in the stage, then let the character sit on the object for a specified duration."
        cls.command_usage = "Navigate the character to a target object, then let the character sit on the chair. Can be used to show behaviors such as resting or waiting."
