...
class PointAttributeManager(RoleAttributeManager):
    """Support class for all attributes of type point

    This encompasses all legal USD types of point3(d|f|h)
    """

    # Hardcoded type configuration using USD. Dictionary key is the OGN attribute type name (without arrays).
    CPP_CONFIGURATION = {
        "pointd[3]": CppConfiguration(
            "pxr::GfVec3d", include_files=["omni/graph/core/ogn/UsdTypes.h"], role="ePosition"
        ),
        "pointf[3]": CppConfiguration(
            "pxr::GfVec3f", include_files=["omni/graph/core/ogn/UsdTypes.h"], role="ePosition"
        ),
        "pointh[3]": CppConfiguration(
            "pxr::GfVec3h", include_files=["omni/graph/core/ogn/UsdTypes.h"], role="ePosition"
        ),
    }
    CUDA_CONFIGURATION = {
        "pointd[3]": CudaConfiguration(
            "double3", include_files=["cuda_fp16.h", "omni/graph/core/cuda/CUDAUtils.h"], role="ePosition"
        ),
        "pointf[3]": CudaConfiguration(
            "float3", include_files=["cuda_fp16.h", "omni/graph/core/cuda/CUDAUtils.h"], role="ePosition"
        ),
        "pointh[3]": CudaConfiguration(
            "__half3", include_files=["cuda_fp16.h", "omni/graph/core/cuda/CUDAUtils.h"], role="ePosition"
        ),
    }
