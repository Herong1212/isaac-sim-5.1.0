...
class ThreadsafeOpen:
    ...
    def __init__(self, path, *args, **kwargs):
        ...
        Args:
            ...
            args: positional arguments passed to the function open()
            kwargs: named arguments passed to the function open()

        Handled named arguments:
            "catch_exceptions": if True, the class will catch I/O exceptions and log warnings, otherwise it
                                forwards the exceptions to the caller. The default is True.
        """
        self.writing_to_file = "r" not in args
        self.catch_exceptions = kwargs.pop("catch_exceptions", True)
