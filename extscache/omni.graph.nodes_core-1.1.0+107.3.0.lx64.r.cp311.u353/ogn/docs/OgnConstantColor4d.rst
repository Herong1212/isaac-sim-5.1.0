.. _omni_graph_nodes_ConstantColor4d_1:

.. _omni_graph_nodes_ConstantColor4d:
...
.. meta::
    :title: Constant Color4d
    :keywords: lang-en omnigraph node constants nodes constant-color4d
...
Container for a double-precision floating-point RGBA color value, mainly used to share a common value between several downstream nodes. The A (alpha) value is not premultiplied.
