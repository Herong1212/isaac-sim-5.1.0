.. _omni_graph_nodes_DotProduct_1:
...
.. csv-table::
    ...
    "Product (*outputs:product*)", "``['double', 'double[]', 'float', 'float[]', 'half', 'half[]', 'timecode']``", "The resulting dot product between vector(s) ""A"" and vector(s) ""B"".", "None"
