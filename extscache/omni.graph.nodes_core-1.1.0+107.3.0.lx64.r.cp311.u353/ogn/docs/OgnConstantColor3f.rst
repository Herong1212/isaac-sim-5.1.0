.. _omni_graph_nodes_ConstantColor3f_1:
...
Container for a single-precision floating-point RGB color value, mainly used to share a common value between several downstream nodes.
