...
Convert the given input to 64-bit floating-point. Array and tuple inputs are converted element-wise to arrays and tuples of the same shape.
...
.. csv-table::
    ...
    "Double (*outputs:converted*)", "``['colord[3]', 'colord[3][]', 'colord[4]', 'colord[4][]', 'double', 'double[2]', 'double[2][]', 'double[3]', 'double[3][]', 'double[4]', 'double[4][]', 'double[]', 'frame[4]', 'frame[4][]', 'matrixd[2]', 'matrixd[2][]', 'matrixd[3]', 'matrixd[3][]', 'matrixd[4]', 'matrixd[4][]', 'normald[3]', 'normald[3][]', 'pointd[3]', 'pointd[3][]', 'quatd[4]', 'quatd[4][]', 'texcoordd[2]', 'texcoordd[2][]', 'texcoordd[3]', 'texcoordd[3][]', 'timecode', 'timecode[]', 'vectord[3]', 'vectord[3][]']``", "The value converted to double form with the role applied.", "None"
