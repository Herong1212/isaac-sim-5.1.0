...
#
"""This module implements a QuickNumberInput widget that provides mouse-driven numeric input with spinner buttons for adjusting integer and float values using Omni UI elements."""
...
GLYPH_CODE_UP = omni.ui.get_custom_glyph_code("${glyphs}/arrow_up.svg")
GLYPH_CODE_DOWN = omni.ui.get_custom_glyph_code("${glyphs}/arrow_down.svg")
TUNE_ARROW_SIZE = 8
FRAME_SPACE = 5
