...
#
"""This module defines an ImageButton class that composes a styled rectangle and image using Omni UI elements to create a clickable UI component with selection state and mouse event handling."""
