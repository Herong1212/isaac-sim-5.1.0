...
#
"""This module defines a singleton that scans a designated icon folder based on the current UI style and retrieves movie capture icons in both SVG and PNG formats."""
...
class MovieCaptureIcons:
    ...
    def __init__(self):
        ...
        try:
            ...
            self._style = self._style or "NvidiaDark"
