...
#
"""This module defines a UIValuesStorage class for managing movie capture UI settings using carb settings and USD stage custom layer data."""
...
class UIValuesStorage:
    ...
    SETTING_NAME_REALTIME_WAIT_FOR_RENDER_RESOLVE = "realtime_wait_for_render_resolve"
    ...
    SETTING_NAME_EARLY_QUIT_TIME_LIMIT = "early_quit_time_limit"
