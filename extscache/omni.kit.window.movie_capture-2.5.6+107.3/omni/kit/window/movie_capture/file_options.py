...
"""This module defines a FileOptions class that encapsulates default settings and methods for managing file type and encoding options for movie capture."""
...
class FileOptions:
    ...
    MP4_ENCODING_RCMODES = ["RC_CONSTQP", "RC_VBR", "RC_CBR", "RC_CBR_LOWDELAY_HQ", "RC_CBR_HQ", "RC_VBR_HQ"]
