...
"""This module provides a FarmStatusWidget using Omni UI to monitor the status of an Omniverse Farm Queue instance and enable users to access its dashboard or setup instructions."""
...
class FarmStatusWidget(ui.Widget):
    ...
    def __init__(self) -> None:
        ...
        self._queue_management_endpoint_prefix: str = settings.get_as_string(
    ...
    async def _check_farm_queue_status(self) -> None:
        ...
        self._open_farm_queue_button.set_tooltip(
            "Checking availability of the Omniverse Farm Queue Management Dashboard"
        )
        ...
        try:
            ...
            self._open_farm_queue_button.text = (
                f"Open Dashboard   {ui.get_custom_glyph_code('${glyphs}/external_link.svg')}"
            )
            self._open_farm_queue_button.set_tooltip(
