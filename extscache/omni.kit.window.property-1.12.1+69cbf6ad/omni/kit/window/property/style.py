...
def get_style():
    ...
    if style_settings == "NvidiaLight":
        ...
        collapsableframe_schemaframe_background_color = 0xFF423232
        ...
        style = {
            ...
            "CollapsableFrame::schemaFrame": {
                "background_color": collapsableframe_schemaframe_background_color,
                "secondary_color": collapsableframe_schemaframe_background_color,
                "border_radius": border_radius * 2,
                "padding": 6,
            },
            "CollapsableFrame::schemaFrame:hovered": {
                "background_color": collapsableframe_schemaframe_background_color,
                "secondary_color": collapsableframe_schemaframe_background_color,
            },
            "CollapsableFrame::schemaFrame:pressed": {
                "background_color": collapsableframe_schemaframe_background_color,
                "secondary_color": collapsableframe_schemaframe_background_color,
            },
            "CollapsableFrame.Header": {
