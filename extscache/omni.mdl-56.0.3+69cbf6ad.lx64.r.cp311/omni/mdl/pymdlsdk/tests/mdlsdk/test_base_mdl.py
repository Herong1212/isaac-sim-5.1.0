...
class MainBaseModules(UnittestBase):
    ...
    def test_IModule(self):
        ...
        self.assertNotEqual(version, pymdlsdk.Mdl_version.MDL_VERSION_1_6)
        self.assertEqual(version, pymdlsdk.Mdl_version.MDL_VERSION_1_7)  # might change at some point
