...
class MainBindings(UnittestBase):
    ...
    def test_abi_version(self):
        print(f"Neuray ABI version: {pymdlsdk.MI_NEURAYLIB_API_VERSION}")
        ...
        print(f"omni.mdl extension version: {version_parts[0]}.{version_parts[1]}.{version_parts[2]}")
        self.assertEqual(str(pymdlsdk.MI_NEURAYLIB_API_VERSION), version_parts[0], "ABI version mismatch.")
