...
class Main(UnittestBase):
    ...
    def setUpClass(self):
        ...
        self.sdk = SDK()
        # UPCOMING self.sdk.load(addExampleSearchPath=True, loadImagePlugins=True, loadDistillerPlugin=True)
        self.sdk.load(addExampleSearchPath=False, loadImagePlugins=False, loadDistillerPlugin=False)
    ...
    def compileMaterialInstance(self, functionCall: pymdlsdk.IFunction_call, classCompilation: bool) -> pymdlsdk.ICompiled_material:
        ...
        if classCompilation:
            flags = pymdlsdk.IMaterial_instance.Compilation_options.CLASS_COMPILATION
        else:
            flags = pymdlsdk.IMaterial_instance.Compilation_options.DEFAULT_OPTIONS
        ...
        compiledMaterial: pymdlsdk.ICompiled_material = materialInstance.create_compiled_material(flags.value, context)
    ...
    def UPCOMING_test_distillAndBake_example_material(self):
