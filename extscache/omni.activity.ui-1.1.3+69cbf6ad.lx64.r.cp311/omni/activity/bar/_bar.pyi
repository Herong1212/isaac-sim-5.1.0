...
import omni.activity.bar._bar
import typing
import omni.ui._ui

__all__ = [
    "AbstractActivityBarDelegate",
    "ActivityBar"
]


class AbstractActivityBarDelegate():
    def __init__(self) -> None: ...
    def get_label(self, index: int) -> str: ...
    def get_tooltip_text(self, index: int) -> str: ...
    pass
class ActivityBar(omni.ui._ui.Widget):
    """
    ...
    def __init__(self, **kwargs) -> None: 
        ...
        ### Keyword Arguments:
            ...
            `thickness : float`
                This property holds the thickness of the rectangle line.
        ...
        """
    def set_selection_changed_fn(self, arg0: typing.Callable[[object], None]) -> None: ...
    @property
    def colors(self) -> typing.List[int]:
        """
        :type: typing.List[int]
        """
    @colors.setter
    def colors(self, arg1: typing.List[int]) -> None:
        pass
    @property
    def delegate(self) -> AbstractActivityBarDelegate:
        """
        :type: AbstractActivityBarDelegate
        """
    @delegate.setter
    def delegate(self, arg1: AbstractActivityBarDelegate) -> None:
        pass
    @property
    def selection(self) -> object:
        ...
        """
    @selection.setter
    def selection(self, arg1: int) -> None:
        pass
    @property
    def time_limit(self) -> typing.Tuple[int, int]:
        """
        :type: typing.Tuple[int, int]
        """
    @time_limit.setter
    def time_limit(self, arg1: typing.Tuple[int, int]) -> None:
        pass
    @property
    def time_ranges(self) -> typing.List[typing.Tuple[int, int]]:
        """
        :type: typing.List[typing.Tuple[int, int]]
        """
    @time_ranges.setter
    def time_ranges(self, arg1: typing.List[typing.Tuple[int, int]]) -> None:
        pass
