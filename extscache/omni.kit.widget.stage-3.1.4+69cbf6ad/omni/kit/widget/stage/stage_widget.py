...
class StageWidget:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._stage_settings.show_inactive_prims = kwargs.pop("show_inactive_prims", True)
        self._stage_settings.show_abstract_prims = kwargs.pop("show_abstract_prims", True)
        ...
        self._icons_subscription = StageIcons().subscribe_icons_changed(self._update_icons)
    ...
    def _build_options_button(self):
        ...
        def _show_inactive_prims(value: bool):
            self.show_inactive_prims = value

        def _show_undefined_prims(value: bool):
            self.show_undefined_prims = value

        def _show_abstract_prims(value: bool):
            self.show_abstract_prims = value
        ...
        option_items = [
            ...
            OptionItem("Show Inactive Prims", default=self.show_inactive_prims, on_value_changed_fn=_show_inactive_prims),
            OptionItem("Show Undefined Prims", default=self.show_undefined_prims, on_value_changed_fn=_show_undefined_prims),
            OptionItem("Show Abstract Prims", default=self.show_abstract_prims, on_value_changed_fn=_show_abstract_prims),
    ...
    def show_inactive_prims(self) -> bool:
        ...
        Returns:
            bool
        """
        return self._stage_settings.show_inactive_prims
    ...
    def show_inactive_prims(self, show: bool):
        ...
        Args:
            show (bool): Value to set.
        """
        if self._stage_settings.show_inactive_prims != show:
            self._stage_settings.show_inactive_prims = show
            self._model.show_inactive_prims = show
    ...
    def show_abstract_prims(self) -> bool:
        ...
        Returns:
            bool
        """
        return self._stage_settings.show_abstract_prims
    ...
    def show_abstract_prims(self, show: bool):
        ...
        Args:
            show (bool): Value to set.
        """
        if self._stage_settings.show_abstract_prims != show:
            self._stage_settings.show_abstract_prims = show
            self._model.show_abstract_prims = show
    ...
    @staticmethod
    def set_widget_visible(widget: ui.Widget, visible):
    ...
    def filter_by_abstract_state(self, enabled):
        ...
        def _is_prim_abstract(prim):
            return prim.IsAbstract()

        self._filter_by_lambda({"_is_prim_abstract": _is_prim_abstract}, enabled)
    ...
    def _on_column_changed(self, column_model: ColumnMenuModel, item: ColumnMenuItem = None):
        ...
        self._fixed_width_columns = [not d.resizable for d in column_delegates]
        self.set_fixed_width_columns()
    ...
    def _get_stage_model(self, stage: Usd.Stage):
        return StageModel(
            ...
            show_inactive_prims=self._stage_settings.show_inactive_prims,
            show_abstract_prims=self._stage_settings.show_abstract_prims,
        )
    ...
    def set_fixed_width_columns(self):
        ...
        for w in [self._tree_view, self._tree_view_flat]:
            if not w:
                continue
            w.fixed_width_columns = self._fixed_width_columns
            w.dirty_widgets()
    ...
    _set_widget_visible = set_widget_visible
    _filter_by_visibility = filter_by_visibility
    _filter_by_active_state = filter_by_active_state
    _filter_by_def_state = filter_by_def_state
    _filter_by_abstract_state = filter_by_abstract_state
    _filter_by_type = filter_by_type
    _filter_by_api_type = filter_by_api_type
    _filter_by_lambda = filter_by_lambda
    _filter_by_text = filter_by_text
