...
__all__ = ["RegistryItem", "RegistriesModel", "EditableDelegate", "ExtsRegistriesWidget"]
...
from .common import REGISTRIES_CHANGED_GLOBAL_EVENT, USER_REGISTRIES_SETTING, get_registries
...
class RegistriesModel(ui.AbstractItemModel):
    ...
    def save(self):  # pragma: no cover
        ...
        # Notify registry
        omni.kit.app.queue_event(REGISTRIES_CHANGED_GLOBAL_EVENT)
...
class EditableDelegate(ui.AbstractItemDelegate):
    ...
    def _show_copy_context_menu(self, x, y, button, modifier, text):  # pragma: no cover
        if button != 1:
            return
    ...
    def on_double_click(self, button, field, label, model, item):  # pragma: no cover
    ...
    def on_end_edit(self, text, field, label, model):  # pragma: no cover
