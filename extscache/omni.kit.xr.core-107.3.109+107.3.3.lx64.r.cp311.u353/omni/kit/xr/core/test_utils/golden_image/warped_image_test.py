...
class WarpedGoldenImageTest(GoldenImageTest):
    def __init__(self, disable_comparison, **kwargs) -> None:
        self.image_types = ["warped.left", "warped.right"]
        self.display_names = ["hmdLeft", "hmdRight"]
        self._image_capturer = DisplayImageCapturer(self.display_names, capture_source="warped", **kwargs)
