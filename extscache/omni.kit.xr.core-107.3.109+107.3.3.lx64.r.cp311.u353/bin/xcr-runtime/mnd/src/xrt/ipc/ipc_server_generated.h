...
xrt_result_t
ipc_handle_instance_is_system_available(volatile struct ipc_client_state *ics,
                                        bool *out_available);

xrt_result_t
ipc_handle_system_get_properties(volatile struct ipc_client_state *ics,
...
xrt_result_t
ipc_handle_system_opaque_data_send(volatile struct ipc_client_state *ics,
                                   uint32_t length);

xrt_result_t
ipc_handle_system_opaque_data_receive(volatile struct ipc_client_state *ics);
...
xrt_result_t
ipc_handle_system_devices_begin_feature(volatile struct ipc_client_state *ics,
                                        enum xrt_device_feature_type type);

xrt_result_t
ipc_handle_system_devices_end_feature(volatile struct ipc_client_state *ics,
                                      enum xrt_device_feature_type type);
...
xrt_result_t
ipc_handle_device_get_pqw_state(volatile struct ipc_client_state *ics,
                                uint32_t id,
...
xrt_result_t
ipc_handle_device_get_override_scaling(volatile struct ipc_client_state *ics,
                                       uint32_t id,
                                       uint64_t at_timestamp_ns,
...
xrt_result_t
ipc_handle_device_get_battery_status(volatile struct ipc_client_state *ics,
                                     uint32_t id,
                                     bool *out_present,
                                     bool *out_charging,
                                     float *out_charge);
