...
typedef enum ipc_command
{
	...
	IPC_INSTANCE_IS_SYSTEM_AVAILABLE,
	...
	IPC_SYSTEM_OPAQUE_DATA_SEND,
	IPC_SYSTEM_OPAQUE_DATA_RECEIVE,
	IPC_SYSTEM_DEVICES_GET_ROLES,
	IPC_SYSTEM_DEVICES_BEGIN_FEATURE,
	IPC_SYSTEM_DEVICES_END_FEATURE,
	...
	IPC_SPACE_LOCATE_SPACES,
	IPC_SPACE_LOCATE_DEVICE,
	IPC_SPACE_DESTROY,
	IPC_SPACE_MARK_REF_SPACE_IN_USE,
	IPC_SPACE_UNMARK_REF_SPACE_IN_USE,
	IPC_SPACE_RECENTER_LOCAL_SPACES,
	IPC_SPACE_GET_TRACKING_ORIGIN_OFFSET,
	IPC_SPACE_SET_TRACKING_ORIGIN_OFFSET,
	IPC_SPACE_GET_REFERENCE_SPACE_OFFSET,
	IPC_SPACE_SET_REFERENCE_SPACE_OFFSET,
	...
	IPC_COMPOSITOR_GET_REFERENCE_BOUNDS_RECT,
	...
	IPC_DEVICE_GET_PQW_STATE,
	IPC_DEVICE_GET_OVERRIDE_SCALING,
	...
	IPC_DEVICE_GET_BODY_SKELETON,
	IPC_DEVICE_GET_BODY_JOINTS,
	IPC_DEVICE_GET_BATTERY_STATUS,
} ipc_command_t;
...
ipc_cmd_to_str(ipc_command_t id)
{
	...
	case IPC_INSTANCE_IS_SYSTEM_AVAILABLE: return "IPC_INSTANCE_IS_SYSTEM_AVAILABLE";
	...
	case IPC_SYSTEM_OPAQUE_DATA_SEND: return "IPC_SYSTEM_OPAQUE_DATA_SEND";
	case IPC_SYSTEM_OPAQUE_DATA_RECEIVE: return "IPC_SYSTEM_OPAQUE_DATA_RECEIVE";
	case IPC_SYSTEM_DEVICES_GET_ROLES: return "IPC_SYSTEM_DEVICES_GET_ROLES";
	case IPC_SYSTEM_DEVICES_BEGIN_FEATURE: return "IPC_SYSTEM_DEVICES_BEGIN_FEATURE";
	case IPC_SYSTEM_DEVICES_END_FEATURE: return "IPC_SYSTEM_DEVICES_END_FEATURE";
	...
	case IPC_SPACE_LOCATE_SPACES: return "IPC_SPACE_LOCATE_SPACES";
	...
	case IPC_SPACE_GET_TRACKING_ORIGIN_OFFSET: return "IPC_SPACE_GET_TRACKING_ORIGIN_OFFSET";
	case IPC_SPACE_SET_TRACKING_ORIGIN_OFFSET: return "IPC_SPACE_SET_TRACKING_ORIGIN_OFFSET";
	case IPC_SPACE_GET_REFERENCE_SPACE_OFFSET: return "IPC_SPACE_GET_REFERENCE_SPACE_OFFSET";
	case IPC_SPACE_SET_REFERENCE_SPACE_OFFSET: return "IPC_SPACE_SET_REFERENCE_SPACE_OFFSET";
	...
	case IPC_COMPOSITOR_GET_REFERENCE_BOUNDS_RECT: return "IPC_COMPOSITOR_GET_REFERENCE_BOUNDS_RECT";
	...
	case IPC_DEVICE_GET_PQW_STATE: return "IPC_DEVICE_GET_PQW_STATE";
	case IPC_DEVICE_GET_OVERRIDE_SCALING: return "IPC_DEVICE_GET_OVERRIDE_SCALING";
	...
	case IPC_DEVICE_GET_BODY_SKELETON: return "IPC_DEVICE_GET_BODY_SKELETON";
	case IPC_DEVICE_GET_BODY_JOINTS: return "IPC_DEVICE_GET_BODY_JOINTS";
	case IPC_DEVICE_GET_BATTERY_STATUS: return "IPC_DEVICE_GET_BATTERY_STATUS";
...
struct ipc_instance_is_system_available_reply
{
	xrt_result_t result;
	bool available;
};
...
struct ipc_system_opaque_data_send_msg
{
	enum ipc_command cmd;
	uint32_t length;
};

struct ipc_system_opaque_data_receive_reply
{
	xrt_result_t result;
	uint32_t length;
};
...
struct ipc_system_devices_begin_feature_msg
{
	enum ipc_command cmd;
	enum xrt_device_feature_type type;
};

struct ipc_system_devices_end_feature_msg
{
	enum ipc_command cmd;
	enum xrt_device_feature_type type;
};
...
struct ipc_space_locate_spaces_msg
{
	enum ipc_command cmd;
	uint32_t base_space_id;
	struct xrt_pose base_offset;
...
struct ipc_space_get_tracking_origin_offset_msg
{
	enum ipc_command cmd;
	uint32_t origin_id;
};

struct ipc_space_get_tracking_origin_offset_reply
{
	xrt_result_t result;
	struct xrt_pose offset;
};

struct ipc_space_set_tracking_origin_offset_msg
{
	enum ipc_command cmd;
	uint32_t origin_id;
	struct xrt_pose offset;
...
struct ipc_space_get_reference_space_offset_msg
{
	enum ipc_command cmd;
	enum xrt_reference_space_type type;
};

struct ipc_space_get_reference_space_offset_reply
{
	xrt_result_t result;
	struct xrt_pose offset;
};

struct ipc_space_set_reference_space_offset_msg
{
	enum ipc_command cmd;
	enum xrt_reference_space_type type;
	struct xrt_pose offset;
...
struct ipc_compositor_get_reference_bounds_rect_msg
{
	enum ipc_command cmd;
	enum xrt_reference_space_type reference_space_type;
};

struct ipc_compositor_get_reference_bounds_rect_reply
{
	xrt_result_t result;
...
struct ipc_device_get_pqw_state_msg
{
	enum ipc_command cmd;
	uint32_t id;
...
struct ipc_device_get_pqw_state_reply
{
	xrt_result_t result;
	struct ipc_info_get_pqw info;
};

struct ipc_device_get_override_scaling_msg
{
	enum ipc_command cmd;
	uint32_t id;
	uint64_t at_timestamp_ns;
...
struct ipc_device_get_override_scaling_reply
{
	xrt_result_t result;
	struct ipc_info_get_override_scaling info;
};
...
struct ipc_device_get_body_skeleton_msg
{
	enum ipc_command cmd;
	uint32_t id;
...
struct ipc_device_get_body_skeleton_reply
{
	xrt_result_t result;
	struct xrt_body_skeleton value;
};

struct ipc_device_get_body_joints_msg
{
	enum ipc_command cmd;
	uint32_t id;
	enum xrt_input_name body_tracking_type;
...
struct ipc_device_get_body_joints_reply
{
	xrt_result_t result;
	struct xrt_body_joint_set value;
};

struct ipc_device_get_battery_status_msg
{
	enum ipc_command cmd;
	uint32_t id;
};

struct ipc_device_get_battery_status_reply
{
	xrt_result_t result;
	bool present;
	bool charging;
