...
bool
oxr_verify_bytedance_pico4_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico4_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/y") == 0) {
				return true;
			} else {
				break;
			}
		case 24:
			if (strcmp(str, "/user/hand/right/input/a") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/b") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_BD_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
...
#if defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_EXT_hand_interaction)
	if (exts->BD_controller_interaction && exts->EXT_hand_interaction) {
		switch (length) {
		case 30:
		...
		case 31:
			if (strcmp(str, "/user/hand/left/input/pinch_ext") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/poke_ext") == 0) {
				return true;
			} else {
				break;
			}
		...
		case 36:
			if (strcmp(str, "/user/hand/left/input/pinch_ext/pose") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/poke_ext/pose") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_EXT_hand_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
...
#endif // defined(OXR_HAVE_EXT_hand_interaction)
	}
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_EXT_palm_pose)
	if (exts->BD_controller_interaction && exts->EXT_palm_pose) {
		switch (length) {
		case 30:
...
#endif // defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_EXT_palm_pose)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
...
#endif // defined(OXR_HAVE_EXT_palm_pose)
	}
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->BD_controller_interaction && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
			} else {
				break;
			}
		case 35:
			if (strcmp(str, "/user/hand/right/input/grip_surface") == 0) {
				return true;
			} else {
				break;
			}
		case 39:
			if (strcmp(str, "/user/hand/left/input/grip_surface/pose") == 0) {
				return true;
			} else {
				break;
			}
		case 40:
			if (strcmp(str, "/user/hand/right/input/grip_surface/pose") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_BD_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
bool
oxr_verify_bytedance_pico4_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico4_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
bool
oxr_verify_bytedance_pico4_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico4_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
#ifdef OXR_HAVE_BD_controller_interaction
	*out_supported = true;
	*out_enabled = extensions->BD_controller_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_BD_controller_interaction
}

bool
oxr_verify_bytedance_pico_g3_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_g3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
		switch (length) {
		case 25:
...
bool
oxr_verify_bytedance_pico_g3_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_g3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
bool
oxr_verify_bytedance_pico_g3_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_g3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
bool
oxr_verify_bytedance_pico_neo3_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_neo3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
		switch (length) {
		case 23:
...
bool
oxr_verify_bytedance_pico_neo3_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_neo3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
bool
oxr_verify_bytedance_pico_neo3_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/bytedance/pico_neo3_controller
#if defined(OXR_HAVE_BD_controller_interaction)
	if (exts->BD_controller_interaction) {
...
bool
oxr_verify_ext_eye_gaze_interaction_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/ext/eye_gaze_interaction
#if defined(OXR_HAVE_EXT_eye_gaze_interaction)
...
#endif // defined(OXR_HAVE_EXT_eye_gaze_interaction)
	return false;
}

bool
oxr_verify_ext_eye_gaze_interaction_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_ext_eye_gaze_interaction_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
oxr_verify_ext_eye_gaze_interaction_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->EXT_eye_gaze_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_EXT_eye_gaze_interaction
}

bool
oxr_verify_ext_hand_interaction_ext_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	...
	if (exts->EXT_hand_interaction) {
		...
		case 37:
			if (strcmp(str, "/user/hand/left/input/grasp_ext/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/pinch_ext/value") == 0) {
				return true;
			} else {
				break;
			}
		case 38:
			if (strcmp(str, "/user/hand/left/input/aim_activate_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_palm_pose)
	if (exts->EXT_hand_interaction && exts->EXT_palm_pose) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_palm_pose)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->EXT_hand_interaction && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
...
bool
oxr_verify_ext_hand_interaction_ext_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_ext_hand_interaction_ext_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
oxr_verify_ext_hand_interaction_ext_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->EXT_hand_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_EXT_hand_interaction
}

bool
oxr_verify_facebook_touch_controller_pro_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/facebook/touch_controller_pro
#if defined(OXR_HAVE_FB_touch_controller_pro)
	if (exts->FB_touch_controller_pro) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
		...
		case 30:
			if (strcmp(str, "/user/hand/left/input/aim/pose") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumb_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/a/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/a/touch") == 0) {
		...
		case 31:
			if (strcmp(str, "/user/hand/left/input/grip/pose") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/stylus_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbrest") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/aim/pose") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumb_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 32:
			if (strcmp(str, "/user/hand/left/input/menu/click") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/stylus_fb") == 0) {
				return true;
		...
		case 37:
			if (strcmp(str, "/user/hand/left/input/stylus_fb/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbrest/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbrest/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/curl_fb") == 0) {
				return true;
		...
		case 38:
			if (strcmp(str, "/user/hand/left/input/thumbstick/click") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/slide_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic_thumb_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/stylus_fb/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbrest/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbrest/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/curl_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 39:
			if (strcmp(str, "/user/hand/right/input/thumbstick/click") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/slide_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/output/haptic_thumb_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 40:
			if (strcmp(str, "/user/hand/left/output/haptic_trigger_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 41:
			if (strcmp(str, "/user/hand/right/output/haptic_trigger_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 42:
			if (strcmp(str, "/user/hand/left/input/trigger/proximity_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 43:
			if (strcmp(str, "/user/hand/left/input/thumb_fb/proximity_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/proximity_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 44:
			if (strcmp(str, "/user/hand/right/input/thumb_fb/proximity_fb") == 0) {
				return true;
			} else {
				break;
			}
		case 45:
			if (strcmp(str, "/user/hand/left/output/haptic_thumb_fb/haptic") == 0) {
				return true;
			} else {
				break;
			}
		case 46:
			if (strcmp(str, "/user/hand/right/output/haptic_thumb_fb/haptic") == 0) {
				return true;
			} else {
				break;
			}
		case 47:
			if (strcmp(str, "/user/hand/left/output/haptic_trigger_fb/haptic") == 0) {
				return true;
			} else {
				break;
			}
		case 48:
			if (strcmp(str, "/user/hand/right/output/haptic_trigger_fb/haptic") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_FB_touch_controller_pro)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_FB_touch_controller_pro)
	if (exts->EXT_hand_interaction && exts->FB_touch_controller_pro) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_FB_touch_controller_pro)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_FB_touch_controller_pro)
	if (exts->EXT_palm_pose && exts->FB_touch_controller_pro) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_FB_touch_controller_pro)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_FB_touch_controller_pro) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->FB_touch_controller_pro && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_FB_touch_controller_pro) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_FB_touch_controller_pro)
		if (exts->FB_touch_controller_pro) {
			switch (length) {
...
bool
oxr_verify_facebook_touch_controller_pro_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/facebook/touch_controller_pro
#if defined(OXR_HAVE_FB_touch_controller_pro)
	if (exts->FB_touch_controller_pro) {
...
bool
oxr_verify_facebook_touch_controller_pro_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/facebook/touch_controller_pro
#if defined(OXR_HAVE_FB_touch_controller_pro)
	if (exts->FB_touch_controller_pro) {
...
#ifdef OXR_HAVE_FB_touch_controller_pro
	*out_supported = true;
	*out_enabled = extensions->FB_touch_controller_pro;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_FB_touch_controller_pro
}

bool
oxr_verify_google_daydream_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	...
	case 33:
		if (strcmp(str, "/user/hand/right/input/trackpad/x") == 0) {
			return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1)
	if (exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
bool
oxr_verify_google_daydream_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/google/daydream_controller
	switch (length) {
	case 38:
	...
	case 40:
		if (strcmp(str, "/user/hand/left/input/trackpad/dpad_down") == 0) {
			return true;
	...
	case 41:
		if (strcmp(str, "/user/hand/left/input/trackpad/dpad_right") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/dpad_down") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/dpad_left") == 0) {
			return true;
		} else {
			break;
		}
...
bool
oxr_verify_google_daydream_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/google/daydream_controller
	switch (length) {
	case 30:
...
bool
oxr_verify_hp_mixed_reality_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/hp/mixed_reality_controller
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
...
#endif // defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
	...
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
	if (exts->EXT_hand_interaction && exts->EXT_hp_mixed_reality_controller) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
	...
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_EXT_palm_pose)
	if (exts->EXT_hp_mixed_reality_controller && exts->EXT_palm_pose) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_EXT_palm_pose)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
		if (exts->EXT_palm_pose) {
			switch (length) {
	...
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->EXT_hp_mixed_reality_controller && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_MNDX_system_buttons)
	if (exts->EXT_hp_mixed_reality_controller && exts->MNDX_system_buttons) {
		switch (length) {
		case 28:
			if (strcmp(str, "/user/hand/left/input/system") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hp_mixed_reality_controller) && defined(OXR_HAVE_MNDX_system_buttons)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_MNDX_system_buttons)
...
#endif // defined(OXR_HAVE_MNDX_system_buttons)
	}
	return false;
}

bool
oxr_verify_hp_mixed_reality_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/hp/mixed_reality_controller
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
	if (exts->EXT_hp_mixed_reality_controller) {
...
bool
oxr_verify_hp_mixed_reality_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/hp/mixed_reality_controller
#if defined(OXR_HAVE_EXT_hp_mixed_reality_controller)
	if (exts->EXT_hp_mixed_reality_controller) {
...
oxr_verify_hp_mixed_reality_controller_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->EXT_hp_mixed_reality_controller;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_EXT_hp_mixed_reality_controller
}

bool
oxr_verify_htc_vive_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
...
bool
oxr_verify_htc_vive_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_controller
	switch (length) {
	case 38:
...
bool
oxr_verify_htc_vive_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_controller
	switch (length) {
	case 30:
...
bool
oxr_verify_htc_vive_cosmos_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_cosmos_controller
#if defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (exts->HTC_vive_cosmos_controller_interaction) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
		...
		case 36:
			if (strcmp(str, "/user/hand/left/input/shoulder/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/squeeze/click") == 0) {
...
#endif // defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
	...
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (exts->EXT_hand_interaction && exts->HTC_vive_cosmos_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
	...
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (exts->EXT_palm_pose && exts->HTC_vive_cosmos_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
		if (exts->EXT_palm_pose) {
			switch (length) {
	...
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->HTC_vive_cosmos_controller_interaction && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
bool
oxr_verify_htc_vive_cosmos_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_cosmos_controller
#if defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (exts->HTC_vive_cosmos_controller_interaction) {
		...
		case 44:
			if (strcmp(str, "/user/hand/left/input/thumbstick/dpad_center") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick/dpad_right") == 0) {
				return true;
			} else {
				break;
			}
		case 45:
			if (strcmp(str, "/user/hand/right/input/thumbstick/dpad_center") == 0) {
				return true;
			} else {
				break;
			}
...
bool
oxr_verify_htc_vive_cosmos_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_cosmos_controller
#if defined(OXR_HAVE_HTC_vive_cosmos_controller_interaction)
	if (exts->HTC_vive_cosmos_controller_interaction) {
...
#ifdef OXR_HAVE_HTC_vive_cosmos_controller_interaction
	*out_supported = true;
	*out_enabled = extensions->HTC_vive_cosmos_controller_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_HTC_vive_cosmos_controller_interaction
}

bool
oxr_verify_htc_vive_focus3_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_focus3_controller
#if defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (exts->HTC_vive_focus3_controller_interaction) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
		...
		case 35:
			if (strcmp(str, "/user/hand/left/input/squeeze/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/squeeze/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/squeeze/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/click") == 0) {
		...
		case 36:
			if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/squeeze/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/squeeze/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/click") == 0) {
...
#endif // defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
	...
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (exts->EXT_hand_interaction && exts->HTC_vive_focus3_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
	...
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (exts->EXT_palm_pose && exts->HTC_vive_focus3_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
		if (exts->EXT_palm_pose) {
			switch (length) {
	...
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_HTC_vive_focus3_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->HTC_vive_focus3_controller_interaction && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_HTC_vive_focus3_controller_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
bool
oxr_verify_htc_vive_focus3_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_focus3_controller
#if defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (exts->HTC_vive_focus3_controller_interaction) {
...
bool
oxr_verify_htc_vive_focus3_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_focus3_controller
#if defined(OXR_HAVE_HTC_vive_focus3_controller_interaction)
	if (exts->HTC_vive_focus3_controller_interaction) {
...
#ifdef OXR_HAVE_HTC_vive_focus3_controller_interaction
	*out_supported = true;
	*out_enabled = extensions->HTC_vive_focus3_controller_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_HTC_vive_focus3_controller_interaction
}

bool
oxr_verify_htc_vive_pro_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
...
bool
oxr_verify_htc_vive_pro_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_htc_vive_pro_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
bool
oxr_verify_htc_vive_tracker_htcx_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/htc/vive_tracker_htcx
#if defined(OXR_HAVE_HTCX_vive_tracker_interaction)
...
#endif // defined(OXR_HAVE_HTCX_vive_tracker_interaction)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTCX_vive_tracker_interaction)
	if (exts->EXT_hand_interaction && exts->HTCX_vive_tracker_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_HTCX_vive_tracker_interaction)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTCX_vive_tracker_interaction)
	if (exts->EXT_palm_pose && exts->HTCX_vive_tracker_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_HTCX_vive_tracker_interaction)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_HTCX_vive_tracker_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->HTCX_vive_tracker_interaction && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_HTCX_vive_tracker_interaction) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_HTCX_vive_tracker_interaction)
		if (exts->HTCX_vive_tracker_interaction) {
			switch (length) {
...
bool
oxr_verify_htc_vive_tracker_htcx_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_htc_vive_tracker_htcx_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
oxr_verify_htc_vive_tracker_htcx_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->HTCX_vive_tracker_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_HTCX_vive_tracker_interaction
}

bool
oxr_verify_khr_simple_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
...
bool
oxr_verify_khr_simple_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_khr_simple_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
bool
oxr_verify_meta_touch_controller_plus_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_plus
#if defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->META_touch_controller_plus) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
		...
		case 32:
			if (strcmp(str, "/user/hand/left/input/menu/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumb_meta") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbstick") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/grip/pose") == 0) {
		...
		case 33:
			if (strcmp(str, "/user/hand/right/input/thumb_meta") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick") == 0) {
				return true;
			} else {
		...
		case 35:
			if (strcmp(str, "/user/hand/left/input/squeeze/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger/value") == 0) {
		...
		case 36:
			if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/value") == 0) {
		...
		case 39:
			if (strcmp(str, "/user/hand/left/input/trigger/curl_meta") == 0) {
				return true;
		...
		case 40:
			if (strcmp(str, "/user/hand/left/input/trigger/slide_meta") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/curl_meta") == 0) {
				return true;
			} else {
				break;
			}
		case 41:
			if (strcmp(str, "/user/hand/right/input/trigger/slide_meta") == 0) {
				return true;
			} else {
				break;
			}
		case 44:
			if (strcmp(str, "/user/hand/left/input/trigger/proximity_meta") == 0) {
				return true;
			} else {
				break;
			}
		case 45:
			if (strcmp(str, "/user/hand/right/input/trigger/proximity_meta") == 0) {
				return true;
			} else {
				break;
			}
		case 47:
			if (strcmp(str, "/user/hand/left/input/thumb_meta/proximity_meta") == 0) {
				return true;
			} else {
				break;
			}
		case 48:
			if (strcmp(str, "/user/hand/right/input/thumb_meta/proximity_meta") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_META_touch_controller_plus)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->EXT_hand_interaction && exts->META_touch_controller_plus) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_META_touch_controller_plus)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->EXT_palm_pose && exts->META_touch_controller_plus) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_META_touch_controller_plus)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->KHR_maintenance1 && exts->META_touch_controller_plus) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_META_touch_controller_plus)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_META_touch_controller_plus)
		if (exts->META_touch_controller_plus) {
			switch (length) {
...
bool
oxr_verify_meta_touch_controller_plus_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_plus
#if defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->META_touch_controller_plus) {
...
bool
oxr_verify_meta_touch_controller_plus_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_plus
#if defined(OXR_HAVE_META_touch_controller_plus)
	if (exts->META_touch_controller_plus) {
...
#ifdef OXR_HAVE_META_touch_controller_plus
	*out_supported = true;
	*out_enabled = extensions->META_touch_controller_plus;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_META_touch_controller_plus
}

bool
oxr_verify_meta_touch_controller_quest_1_rift_s_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_1_rift_s
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
		...
		case 39:
			if (strcmp(str, "/user/hand/left/input/trigger/proximity") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick/touch") == 0) {
		...
		case 40:
			if (strcmp(str, "/user/hand/right/input/trigger/proximity") == 0) {
				return true;
			} else {
				break;
			}
		case 44:
			if (strcmp(str, "/user/hand/left/input/thumb_resting_surfaces") == 0) {
				return true;
			} else {
				break;
			}
		case 45:
			if (strcmp(str, "/user/hand/right/input/thumb_resting_surfaces") == 0) {
				return true;
			} else {
				break;
			}
		case 54:
			if (strcmp(str, "/user/hand/left/input/thumb_resting_surfaces/proximity") == 0) {
				return true;
			} else {
				break;
			}
		case 55:
			if (strcmp(str, "/user/hand/right/input/thumb_resting_surfaces/proximity") == 0) {
				return true;
			} else {
				break;
			}
...
bool
oxr_verify_meta_touch_controller_quest_1_rift_s_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_1_rift_s
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_controller_quest_1_rift_s_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_1_rift_s
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_controller_quest_2_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_2
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
...
bool
oxr_verify_meta_touch_controller_quest_2_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_2
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_controller_quest_2_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_quest_2
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_controller_rift_cv1_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_rift_cv1
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
...
bool
oxr_verify_meta_touch_controller_rift_cv1_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_rift_cv1
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_controller_rift_cv1_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_controller_rift_cv1
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_plus_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_plus_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
		...
		case 34:
			if (strcmp(str, "/user/hand/left/input/thumbstick/x") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger_curl") == 0) {
				return true;
			} else {
				break;
			}
		case 35:
			if (strcmp(str, "/user/hand/left/input/squeeze/value") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/left/input/trigger_slide") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/system/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick/x") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger_curl") == 0) {
				return true;
			} else {
				break;
			}
		case 36:
			if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger_slide") == 0) {
				return true;
			} else {
				break;
			}
		...
		case 40:
			if (strcmp(str, "/user/hand/left/input/trigger_curl/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger/proximity") == 0) {
				return true;
			} else {
				break;
			}
		case 41:
			if (strcmp(str, "/user/hand/left/input/trigger_slide/value") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger_curl/value") == 0) {
				return true;
			} else {
				break;
			}
		case 42:
			if (strcmp(str, "/user/hand/right/input/trigger_slide/value") == 0) {
				return true;
			} else {
				break;
			}
...
bool
oxr_verify_meta_touch_plus_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_plus_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_plus_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_plus_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_pro_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_pro_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
		...
		case 28:
			if (strcmp(str, "/user/hand/left/input/stylus") == 0) {
				return true;
			} else {
				break;
			}
		case 29:
			if (strcmp(str, "/user/hand/left/input/squeeze") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/input/stylus") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/system") == 0) {
				return true;
			} else {
		...
		case 34:
			if (strcmp(str, "/user/hand/left/input/stylus/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbstick/x") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbstick/y") == 0) {
		...
		case 35:
			if (strcmp(str, "/user/hand/left/input/squeeze/value") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic_thumb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/stylus/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/system/click") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/thumbstick/x") == 0) {
		...
		case 36:
			if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/output/haptic_thumb") == 0) {
				return true;
			} else {
				break;
			}
		case 37:
			if (strcmp(str, "/user/hand/left/input/thumbrest/force") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/thumbrest/touch") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic_trigger") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/output/haptic/haptic") == 0) {
				return true;
			} else {
		...
		case 38:
			if (strcmp(str, "/user/hand/left/input/thumbstick/click") == 0) {
				...
				return true;
			} else if (strcmp(str, "/user/hand/right/output/haptic_trigger") == 0) {
				return true;
			} else {
				break;
			}
		...
		case 42:
			if (strcmp(str, "/user/hand/left/output/haptic_thumb/haptic") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger_slide/value") == 0) {
				return true;
			} else {
				break;
			}
		case 43:
			if (strcmp(str, "/user/hand/right/output/haptic_thumb/haptic") == 0) {
				return true;
			} else {
				break;
			}
		case 44:
			if (strcmp(str, "/user/hand/left/input/thumb_resting_surfaces") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic_trigger/haptic") == 0) {
				return true;
			} else {
				break;
			}
		case 45:
			if (strcmp(str, "/user/hand/right/input/thumb_resting_surfaces") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/output/haptic_trigger/haptic") == 0) {
				return true;
			} else {
				break;
			}
...
bool
oxr_verify_meta_touch_pro_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_pro_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_meta_touch_pro_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/meta/touch_pro_controller
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
...
bool
oxr_verify_microsoft_hand_interaction_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/hand_interaction
#if defined(OXR_HAVE_MSFT_hand_interaction)
...
#endif // defined(OXR_HAVE_MSFT_hand_interaction)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MSFT_hand_interaction)
	if (exts->EXT_hand_interaction && exts->MSFT_hand_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MSFT_hand_interaction)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MSFT_hand_interaction)
	if (exts->EXT_palm_pose && exts->MSFT_hand_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MSFT_hand_interaction)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MSFT_hand_interaction)
	if (exts->KHR_maintenance1 && exts->MSFT_hand_interaction) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MSFT_hand_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_MSFT_hand_interaction)
		if (exts->MSFT_hand_interaction) {
			switch (length) {
...
bool
oxr_verify_microsoft_hand_interaction_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_microsoft_hand_interaction_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
oxr_verify_microsoft_hand_interaction_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->MSFT_hand_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_MSFT_hand_interaction
}

bool
oxr_verify_microsoft_motion_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
...
bool
oxr_verify_microsoft_motion_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/motion_controller
	switch (length) {
	case 38:
...
bool
oxr_verify_microsoft_motion_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/motion_controller
	switch (length) {
	case 30:
...
bool
oxr_verify_microsoft_xbox_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/xbox_controller
	switch (length) {
	case 21:
		if (strcmp(str, "/user/gamepad/input/a") == 0) {
			return true;
	...
	case 24:
		if (strcmp(str, "/user/gamepad/input/menu") == 0) {
			return true;
		} else if (strcmp(str, "/user/gamepad/input/view") == 0) {
			return true;
		} else {
			break;
		}
	...
	case 32:
		if (strcmp(str, "/user/gamepad/input/trigger_left") == 0) {
			return true;
		} else if (strcmp(str, "/user/gamepad/output/haptic_left") == 0) {
			return true;
		} else {
			break;
		}
...
bool
oxr_verify_microsoft_xbox_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/xbox_controller
	switch (length) {
	case 43:
...
bool
oxr_verify_microsoft_xbox_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/microsoft/xbox_controller
	switch (length) {
	case 35:
...
bool
oxr_verify_ml_ml2_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/ml/ml2_controller
#if defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->ML_ml2_controller_interaction) {
		...
		case 26:
			if (strcmp(str, "/user/hand/left/input/grip") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/home") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/menu") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/aim") == 0) {
		...
		case 32:
			if (strcmp(str, "/user/hand/left/input/home/click") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 25:
			if (strcmp(str, "/user/hand/left/input/aim") == 0) {
	...
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->EXT_hand_interaction && exts->ML_ml2_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
	...
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->EXT_palm_pose && exts->ML_ml2_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
		if (exts->EXT_palm_pose) {
			switch (length) {
	...
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->KHR_maintenance1 && exts->ML_ml2_controller_interaction) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
bool
oxr_verify_ml_ml2_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/ml/ml2_controller
#if defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->ML_ml2_controller_interaction) {
...
bool
oxr_verify_ml_ml2_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/ml/ml2_controller
#if defined(OXR_HAVE_ML_ml2_controller_interaction)
	if (exts->ML_ml2_controller_interaction) {
...
oxr_verify_ml_ml2_controller_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->ML_ml2_controller_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_ML_ml2_controller_interaction
}

bool
oxr_verify_mndx_ball_on_a_stick_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/mndx/ball_on_a_stick_controller
#if defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	if (exts->MNDX_ball_on_a_stick_controller) {
		...
		case 32:
			if (strcmp(str, "/user/hand/left/input/cross_mndx") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/input/menu/click") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	if (exts->EXT_hand_interaction && exts->MNDX_ball_on_a_stick_controller) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	if (exts->EXT_palm_pose && exts->MNDX_ball_on_a_stick_controller) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	if (exts->KHR_maintenance1 && exts->MNDX_ball_on_a_stick_controller) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_MNDX_ball_on_a_stick_controller)
		if (exts->MNDX_ball_on_a_stick_controller) {
			switch (length) {
...
bool
oxr_verify_mndx_ball_on_a_stick_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}

bool
oxr_verify_mndx_ball_on_a_stick_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	return false;
}
...
oxr_verify_mndx_ball_on_a_stick_controller_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->MNDX_ball_on_a_stick_controller;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_MNDX_ball_on_a_stick_controller
}

bool
oxr_verify_mndx_hydra_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/mndx/hydra
#if defined(OXR_HAVE_MNDX_hydra)
	if (exts->MNDX_hydra) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/1") == 0) {
				return true;
		...
		case 24:
			if (strcmp(str, "/user/hand/right/input/1") == 0) {
				return true;
		...
		case 29:
			if (strcmp(str, "/user/hand/left/input/1/click") == 0) {
				return true;
		...
		case 30:
			if (strcmp(str, "/user/hand/right/input/1/click") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_MNDX_hydra)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MNDX_hydra)
	if (exts->EXT_hand_interaction && exts->MNDX_hydra) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_MNDX_hydra)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MNDX_hydra)
	if (exts->EXT_palm_pose && exts->MNDX_hydra) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_MNDX_hydra)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MNDX_hydra)
	if (exts->KHR_maintenance1 && exts->MNDX_hydra) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_MNDX_hydra)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_MNDX_hydra)
		if (exts->MNDX_hydra) {
			switch (length) {
...
bool
oxr_verify_mndx_hydra_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/mndx/hydra
#if defined(OXR_HAVE_MNDX_hydra)
	if (exts->MNDX_hydra) {
...
bool
oxr_verify_mndx_hydra_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/mndx/hydra
#if defined(OXR_HAVE_MNDX_hydra)
	if (exts->MNDX_hydra) {
...
oxr_verify_mndx_hydra_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->MNDX_hydra;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_MNDX_hydra
}

bool
oxr_verify_oculus_go_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	...
	case 33:
		if (strcmp(str, "/user/hand/right/input/back/click") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/x") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/y") == 0) {
...
bool
oxr_verify_oculus_go_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oculus/go_controller
	switch (length) {
	case 38:
...
bool
oxr_verify_oculus_go_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oculus/go_controller
	switch (length) {
	case 30:
...
bool
oxr_verify_oculus_touch_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	...
	// generated from: /virtual_profiles/oculus/touch_controller_proximity_1_1
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 29:
			if (strcmp(str, "/user/hand/left/input/trigger") == 0) {
	...
	// generated from: /virtual_profiles/oculus/touch_controller_proximity_fb
#if defined(OXR_HAVE_FB_touch_controller_proximity)
	if (exts->FB_touch_controller_proximity) {
		switch (length) {
		case 29:
			if (strcmp(str, "/user/hand/left/input/trigger") == 0) {
				return true;
		...
		case 30:
			if (strcmp(str, "/user/hand/left/input/thumb_fb") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/trigger") == 0) {
				return true;
			} else {
		...
		case 31:
			if (strcmp(str, "/user/hand/right/input/thumb_fb") == 0) {
				return true;
			} else {
				break;
			}
...
#endif // defined(OXR_HAVE_FB_touch_controller_proximity)
	return false;
}

bool
oxr_verify_oculus_touch_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oculus/touch_controller
	switch (length) {
	case 40:
...
bool
oxr_verify_oculus_touch_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oculus/touch_controller
	switch (length) {
	case 32:
...
bool
oxr_verify_oppo_mr_controller_oppo_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oppo/mr_controller_oppo
#if defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->OPPO_controller_interaction) {
		switch (length) {
		case 23:
			if (strcmp(str, "/user/hand/left/input/x") == 0) {
				return true;
		...
		case 36:
			if (strcmp(str, "/user/hand/left/input/heartrate_oppo") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
				return true;
			} else if (strcmp(str, "/user/hand/right/input/squeeze/value") == 0) {
...
#endif // defined(OXR_HAVE_OPPO_controller_interaction)
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->EXT_hand_interaction && exts->OPPO_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_OPPO_controller_interaction)
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->EXT_palm_pose && exts->OPPO_controller_interaction) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_OPPO_controller_interaction)
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->KHR_maintenance1 && exts->OPPO_controller_interaction) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_KHR_maintenance1) && defined(OXR_HAVE_OPPO_controller_interaction)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_OPPO_controller_interaction)
		if (exts->OPPO_controller_interaction) {
			switch (length) {
...
bool
oxr_verify_oppo_mr_controller_oppo_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oppo/mr_controller_oppo
#if defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->OPPO_controller_interaction) {
...
bool
oxr_verify_oppo_mr_controller_oppo_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/oppo/mr_controller_oppo
#if defined(OXR_HAVE_OPPO_controller_interaction)
	if (exts->OPPO_controller_interaction) {
...
oxr_verify_oppo_mr_controller_oppo_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->OPPO_controller_interaction;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_OPPO_controller_interaction
}

bool
oxr_verify_samsung_odyssey_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/samsung/odyssey_controller
#if defined(OXR_HAVE_EXT_samsung_odyssey_controller)
...
#endif // defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 25:
			if (strcmp(str, "/user/hand/left/input/aim") == 0) {
	...
	// generated from: /virtual_profiles/ext/hand_interaction_poses
#if defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (exts->EXT_hand_interaction && exts->EXT_samsung_odyssey_controller) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/poke_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_hand_interaction) && defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_hand_interaction)
		if (exts->EXT_hand_interaction) {
			switch (length) {
	...
	// generated from: /virtual_profiles/ext/palm_pose
#if defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (exts->EXT_palm_pose && exts->EXT_samsung_odyssey_controller) {
		switch (length) {
		case 30:
			if (strcmp(str, "/user/hand/left/input/palm_ext") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_palm_pose) && defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_EXT_palm_pose)
		if (exts->EXT_palm_pose) {
			switch (length) {
	...
	// generated from: /virtual_profiles/grip_surface
#if defined(OXR_HAVE_EXT_samsung_odyssey_controller) && defined(OXR_HAVE_KHR_maintenance1)
	if (exts->EXT_samsung_odyssey_controller && exts->KHR_maintenance1) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_samsung_odyssey_controller) && defined(OXR_HAVE_KHR_maintenance1)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
		switch (length) {
		case 34:
			if (strcmp(str, "/user/hand/left/input/grip_surface") == 0) {
...
#if defined(OXR_HAVE_EXT_samsung_odyssey_controller) && defined(OXR_HAVE_MNDX_system_buttons)
	if (exts->EXT_samsung_odyssey_controller && exts->MNDX_system_buttons) {
		switch (length) {
		case 28:
			if (strcmp(str, "/user/hand/left/input/system") == 0) {
				return true;
...
#endif // defined(OXR_HAVE_EXT_samsung_odyssey_controller) && defined(OXR_HAVE_MNDX_system_buttons)
	if (openxr_version >= XR_MAKE_VERSION(1, 1, 0)) {
#if defined(OXR_HAVE_MNDX_system_buttons)
		if (exts->MNDX_system_buttons) {
			switch (length) {
...
bool
oxr_verify_samsung_odyssey_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/samsung/odyssey_controller
#if defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (exts->EXT_samsung_odyssey_controller) {
...
bool
oxr_verify_samsung_odyssey_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/samsung/odyssey_controller
#if defined(OXR_HAVE_EXT_samsung_odyssey_controller)
	if (exts->EXT_samsung_odyssey_controller) {
...
oxr_verify_samsung_odyssey_controller_ext(const struct oxr_extension_status *extensions, XrVersion openxr_version, bool *out_supported, bool *out_enabled)
{
	...
	*out_supported = true;
	*out_enabled = extensions->EXT_samsung_odyssey_controller;
#else
	*out_supported = false;
	*out_enabled = false;
#endif // OXR_HAVE_EXT_samsung_odyssey_controller
}

bool
oxr_verify_valve_index_controller_subpath(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/valve/index_controller
	switch (length) {
	case 23:
		if (strcmp(str, "/user/hand/left/input/a") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/b") == 0) {
			return true;
		} else {
			break;
		}
	...
	case 29:
		if (strcmp(str, "/user/hand/left/input/a/click") == 0) {
			return true;
	...
	case 36:
		if (strcmp(str, "/user/hand/left/input/trackpad/force") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/input/trackpad/touch") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/left/output/haptic/haptic") == 0) {
	...
	case 37:
		if (strcmp(str, "/user/hand/right/input/trackpad/force") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/input/trackpad/touch") == 0) {
			return true;
		} else if (strcmp(str, "/user/hand/right/output/haptic/haptic") == 0) {
...
bool
oxr_verify_valve_index_controller_dpad_path(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/valve/index_controller
	switch (length) {
	case 38:
...
bool
oxr_verify_valve_index_controller_dpad_emulator(const struct oxr_extension_status *exts, XrVersion openxr_version, const char *str, size_t length)
{
	// generated from: /interaction_profiles/valve/index_controller
	switch (length) {
	case 30:
...
struct profile_template profile_templates[31] = { // array of profile_template
	{ // profile_template
		.name = XRT_DEVICE_PICO4_CONTROLLER,
		.path = "/interaction_profiles/bytedance/pico4_controller",
		.localized_name = "Bytedance PICO 4 controller",
		.steamvr_input_profile_path = "bytedance_pico4_controller_profile.json",
		.steamvr_controller_type = "monado_bytedance_pico4_controller",
		.binding_count = 42,
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 4
				...
				.input = XRT_INPUT_PICO4_SQUEEZE_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
				...
				.input = XRT_INPUT_PICO4_SQUEEZE_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 5
			{ // binding_template 6
			...
			{ // binding_template 8
				...
				.input = XRT_INPUT_PICO4_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 8
			{ // binding_template 9
				...
				.input = XRT_INPUT_PICO4_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 9
			{ // binding_template 10
				...
				.input = XRT_INPUT_PICO4_THUMBSTICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 10
			{ // binding_template 11
			...
			{ // binding_template 14
				...
				.input = XRT_INPUT_PICO4_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 14
			{ // binding_template 15
			...
			{ // binding_template 16
				...
				.input = XRT_INPUT_PICO4_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 16
			{ // binding_template 17
			...
			{ // binding_template 18
				...
				.input = XRT_INPUT_PICO4_TRIGGER_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				...
				.input = XRT_INPUT_PICO4_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
				...
				.input = XRT_INPUT_PICO4_TRIGGER_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 20
			{ // binding_template 21
			...
			{ // binding_template 28
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_PICO4_HAPTIC,
			}, // /binding_template 28
			{ // binding_template 29
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 30
				...
				.input = XRT_INPUT_PICO4_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 30
			{ // binding_template 31
			...
			{ // binding_template 32
				...
				.input = XRT_INPUT_PICO4_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 32
			{ // binding_template 33
		...
		.dpads = (struct dpad_emulation[]){ // array of dpad_emulation
			{
				...
				.position = XRT_INPUT_PICO4_THUMBSTICK,
				.activate = 0			},
			{
				.subaction_path = "/user/hand/right",
				.paths = {
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_bytedance_pico4_controller_subpath,
		.dpad_path_fn = oxr_verify_bytedance_pico4_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_bytedance_pico4_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_bytedance_pico4_controller_ext,
		.extension_name = "BD_controller_interaction",
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_PICO_G3_CONTROLLER,
		.path = "/interaction_profiles/bytedance/pico_g3_controller",
		.localized_name = "Bytedance PICO G3 controller",
		.steamvr_input_profile_path = "bytedance_pico_g3_controller_profile.json",
		.steamvr_controller_type = "monado_bytedance_pico_g3_controller",
		.binding_count = 22,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/left",
				...
				.input = XRT_INPUT_PICO_G3_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_PICO_G3_THUMBSTICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
			...
			{ // binding_template 4
				...
				.input = XRT_INPUT_PICO_G3_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
			...
			{ // binding_template 6
				...
				.input = XRT_INPUT_PICO_G3_TRIGGER_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 6
			{ // binding_template 7
				...
				.input = XRT_INPUT_PICO_G3_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 7
			{ // binding_template 8
			...
			{ // binding_template 10
				...
				.input = XRT_INPUT_PICO_G3_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 10
			{ // binding_template 11
			...
			{ // binding_template 12
				...
				.input = XRT_INPUT_PICO_G3_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 12
			{ // binding_template 13
		...
		.dpads = (struct dpad_emulation[]){ // array of dpad_emulation
			{
				...
				.position = XRT_INPUT_PICO_G3_THUMBSTICK,
				.activate = 0			},
			{
				.subaction_path = "/user/hand/right",
				.paths = {
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_bytedance_pico_g3_controller_subpath,
		.dpad_path_fn = oxr_verify_bytedance_pico_g3_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_bytedance_pico_g3_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_bytedance_pico_g3_controller_ext,
		.extension_name = "BD_controller_interaction",
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_PICO_NEO3_CONTROLLER,
		.path = "/interaction_profiles/bytedance/pico_neo3_controller",
		.localized_name = "Bytedance PICO Neo 3 controller",
		.steamvr_input_profile_path = "bytedance_pico_neo3_controller_profile.json",
		.steamvr_controller_type = "monado_bytedance_pico_neo3_controller",
		.binding_count = 42,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
				...
				.input = XRT_INPUT_PICO_NEO3_A_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_PICO_NEO3_A_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
				...
				.input = XRT_INPUT_PICO_NEO3_B_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 2
			{ // binding_template 3
				...
				.input = XRT_INPUT_PICO_NEO3_B_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 3
			{ // binding_template 4
				...
				.input = XRT_INPUT_PICO_NEO3_SQUEEZE_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
				...
				.input = XRT_INPUT_PICO_NEO3_SQUEEZE_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 5
			{ // binding_template 6
			...
			{ // binding_template 8
				...
				.input = XRT_INPUT_PICO_NEO3_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 8
			{ // binding_template 9
				...
				.input = XRT_INPUT_PICO_NEO3_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 9
			{ // binding_template 10
				...
				.input = XRT_INPUT_PICO_NEO3_THUMBSTICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 10
			{ // binding_template 11
			...
			{ // binding_template 14
				...
				.input = XRT_INPUT_PICO_NEO3_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 14
			{ // binding_template 15
			...
			{ // binding_template 16
				...
				.input = XRT_INPUT_PICO_NEO3_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 16
			{ // binding_template 17
			...
			{ // binding_template 18
				...
				.input = XRT_INPUT_PICO_NEO3_TRIGGER_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				...
				.input = XRT_INPUT_PICO_NEO3_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
				...
				.input = XRT_INPUT_PICO_NEO3_TRIGGER_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 20
			{ // binding_template 21
			...
			{ // binding_template 24
				...
				.input = XRT_INPUT_PICO_NEO3_X_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 24
			{ // binding_template 25
				...
				.input = XRT_INPUT_PICO_NEO3_X_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 25
			{ // binding_template 26
				...
				.input = XRT_INPUT_PICO_NEO3_Y_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 26
			{ // binding_template 27
				...
				.input = XRT_INPUT_PICO_NEO3_Y_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 27
			{ // binding_template 28
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_PICO_NEO3_HAPTIC,
			}, // /binding_template 28
			{ // binding_template 29
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 30
				...
				.input = XRT_INPUT_PICO_NEO3_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 30
			{ // binding_template 31
			...
			{ // binding_template 32
				...
				.input = XRT_INPUT_PICO_NEO3_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 32
			{ // binding_template 33
		...
		.dpads = (struct dpad_emulation[]){ // array of dpad_emulation
			{
				...
				.position = XRT_INPUT_PICO_NEO3_THUMBSTICK,
				.activate = 0			},
			{
				.subaction_path = "/user/hand/right",
				.paths = {
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_bytedance_pico_neo3_controller_subpath,
		.dpad_path_fn = oxr_verify_bytedance_pico_neo3_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_bytedance_pico_neo3_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_bytedance_pico_neo3_controller_ext,
		.extension_name = "BD_controller_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.dpad_count = 0,
		.dpads = NULL,
		.openxr_version.promoted.major = 0,
		.openxr_version.promoted.minor = 0,
		...
		.ext_verify_fn = oxr_verify_ext_eye_gaze_interaction_ext,
		.extension_name = "EXT_eye_gaze_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_ext_hand_interaction_ext_ext,
		.extension_name = "EXT_hand_interaction",
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_PRO_CONTROLLER,
		.path = "/interaction_profiles/facebook/touch_controller_pro",
		.localized_name = "Meta Quest Touch Pro Controller",
		.steamvr_input_profile_path = "facebook_touch_controller_pro_profile.json",
		.steamvr_controller_type = "monado_facebook_touch_controller_pro",
		.binding_count = 54,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
				...
				.input = XRT_INPUT_TOUCH_PRO_A_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_TOUCH_PRO_A_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
				...
				.input = XRT_INPUT_TOUCH_PRO_B_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 2
			{ // binding_template 3
				...
				.input = XRT_INPUT_TOUCH_PRO_B_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 3
			{ // binding_template 4
				...
				.input = XRT_INPUT_TOUCH_PRO_SQUEEZE_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
			...
			{ // binding_template 6
				...
				.input = XRT_INPUT_TOUCH_PRO_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 6
			{ // binding_template 7
				...
				.input = XRT_INPUT_TOUCH_PRO_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 7
			{ // binding_template 8
				...
				.input = XRT_INPUT_TOUCH_PRO_THUMBSTICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 8
			{ // binding_template 9
			...
			{ // binding_template 12
				...
				.input = XRT_INPUT_TOUCH_PRO_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 12
			{ // binding_template 13
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/stylus_fb/force",
				.localized_name = "Stylus",
				.paths = { // array of paths
					"/user/hand/left/input/stylus_fb/force",
					"/user/hand/left/input/stylus_fb",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PRO_STYLUS_FORCE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 13
			{ // binding_template 14
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/stylus_fb",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PRO_STYLUS_FORCE,
				.dpad_activate = 0,
			...
			{ // binding_template 15
				...
				.input = XRT_INPUT_TOUCH_PRO_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 15
			{ // binding_template 16
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/thumb_fb",
				.localized_name = "Thumb",
				.paths = { // array of paths
					"/user/hand/left/input/thumb_fb/proximity_fb",
					"/user/hand/left/input/thumb_fb",
					NULL
				}, // /array of paths
			}, // /binding_template 16
			{ // binding_template 17
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/thumb_fb",
					NULL
				}, // /array of paths
			}, // /binding_template 17
			{ // binding_template 18
				...
				.input = XRT_INPUT_TOUCH_PRO_THUMBREST_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/thumbrest/force",
				.localized_name = "Thumb Rest",
				.paths = { // array of paths
				...
				.input = XRT_INPUT_TOUCH_PRO_THUMBREST_FORCE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
			...
			{ // binding_template 22
				...
				.input = XRT_INPUT_TOUCH_PRO_TRIGGER_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 22
			{ // binding_template 23
				...
				.input = XRT_INPUT_TOUCH_PRO_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 23
			{ // binding_template 24
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/trigger",
				.localized_name = "Trigger",
				.paths = { // array of paths
			...
			{ // binding_template 32
				...
				.input = XRT_INPUT_TOUCH_PRO_X_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 32
			{ // binding_template 33
				...
				.input = XRT_INPUT_TOUCH_PRO_X_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 33
			{ // binding_template 34
				...
				.input = XRT_INPUT_TOUCH_PRO_Y_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 34
			{ // binding_template 35
				...
				.input = XRT_INPUT_TOUCH_PRO_Y_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 35
			{ // binding_template 36
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC,
			}, // /binding_template 36
			{ // binding_template 37
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 38
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/output/haptic_thumb_fb",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/left/output/haptic_thumb_fb/haptic",
					"/user/hand/left/output/haptic_thumb_fb",
					NULL
				}, // /array of paths
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_THUMB,
			}, // /binding_template 38
			{ // binding_template 39
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic_thumb_fb",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/right/output/haptic_thumb_fb/haptic",
			...
			{ // binding_template 40
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/output/haptic_trigger_fb",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/left/output/haptic_trigger_fb/haptic",
					"/user/hand/left/output/haptic_trigger_fb",
					NULL
				}, // /array of paths
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_TRIGGER,
			}, // /binding_template 40
			{ // binding_template 41
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic_trigger_fb",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/right/output/haptic_trigger_fb/haptic",
			...
			{ // binding_template 42
				...
				.input = XRT_INPUT_TOUCH_PRO_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 42
			{ // binding_template 43
			...
			{ // binding_template 44
				...
				.input = XRT_INPUT_TOUCH_PRO_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 44
			{ // binding_template 45
		...
		.openxr_version.promoted.major = 0,
		.openxr_version.promoted.minor = 0,
		.subpath_fn = oxr_verify_facebook_touch_controller_pro_subpath,
		.dpad_path_fn = oxr_verify_facebook_touch_controller_pro_dpad_path,
		.dpad_emulator_fn = oxr_verify_facebook_touch_controller_pro_dpad_emulator,
		.ext_verify_fn = oxr_verify_facebook_touch_controller_pro_ext,
		.extension_name = "FB_touch_controller_pro",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_google_daydream_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_hp_mixed_reality_controller_ext,
		.extension_name = "EXT_hp_mixed_reality_controller",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_htc_vive_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_VIVE_COSMOS_CONTROLLER,
		.path = "/interaction_profiles/htc/vive_cosmos_controller",
		.localized_name = "HTC Vive Cosmos Controller",
		.steamvr_input_profile_path = "htc_vive_cosmos_controller_profile.json",
		.steamvr_controller_type = "monado_htc_vive_cosmos_controller",
		.binding_count = 34,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
				...
				.input = XRT_INPUT_VIVE_COSMOS_A_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_VIVE_COSMOS_B_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
				...
				.input = XRT_INPUT_VIVE_COSMOS_SQUEEZE_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 2
			{ // binding_template 3
			...
			{ // binding_template 4
				...
				.input = XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
				...
				.input = XRT_INPUT_VIVE_COSMOS_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 5
			{ // binding_template 6
				...
				.input = XRT_INPUT_VIVE_COSMOS_THUMBSTICK,
				.dpad_activate = XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK,
				.output = 0,
			}, // /binding_template 6
			{ // binding_template 7
				.subaction_path = "/user/hand/right",
			...
			{ // binding_template 10
				...
				.input = XRT_INPUT_VIVE_COSMOS_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 10
			{ // binding_template 11
			...
			{ // binding_template 13
				...
				.input = XRT_INPUT_VIVE_COSMOS_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 13
			{ // binding_template 14
				...
				.input = XRT_INPUT_VIVE_COSMOS_TRIGGER_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 14
			{ // binding_template 15
				...
				.input = XRT_INPUT_VIVE_COSMOS_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 15
			{ // binding_template 16
			...
			{ // binding_template 18
				...
				.input = XRT_INPUT_VIVE_COSMOS_X_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				...
				.input = XRT_INPUT_VIVE_COSMOS_Y_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_VIVE_COSMOS_HAPTIC,
			}, // /binding_template 20
			{ // binding_template 21
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 22
				...
				.input = XRT_INPUT_VIVE_COSMOS_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 22
			{ // binding_template 23
			...
			{ // binding_template 24
				...
				.input = XRT_INPUT_VIVE_COSMOS_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 24
			{ // binding_template 25
		...
		.dpads = (struct dpad_emulation[]){ // array of dpad_emulation
			{
				...
				.paths = {
					...
					"/user/hand/left/input/thumbstick/dpad_left",
					"/user/hand/left/input/thumbstick/dpad_right",
					"/user/hand/left/input/thumbstick/dpad_center",
				},
				.position = XRT_INPUT_VIVE_COSMOS_THUMBSTICK,
				.activate = XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK,
			},
			{
				.subaction_path = "/user/hand/right",
				.paths = {
					...
					"/user/hand/right/input/thumbstick/dpad_left",
					"/user/hand/right/input/thumbstick/dpad_right",
					"/user/hand/right/input/thumbstick/dpad_center",
				},
				.position = XRT_INPUT_VIVE_COSMOS_THUMBSTICK,
				.activate = XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK,
			},
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_htc_vive_cosmos_controller_subpath,
		.dpad_path_fn = oxr_verify_htc_vive_cosmos_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_htc_vive_cosmos_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_htc_vive_cosmos_controller_ext,
		.extension_name = "HTC_vive_cosmos_controller_interaction",
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_VIVE_FOCUS3_CONTROLLER,
		.path = "/interaction_profiles/htc/vive_focus3_controller",
		.localized_name = "HTC Vive Focus 3 Controller",
		.steamvr_input_profile_path = "htc_vive_focus3_controller_profile.json",
		.steamvr_controller_type = "monado_htc_vive_focus3_controller",
		.binding_count = 40,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
				...
				.input = XRT_INPUT_VIVE_FOCUS3_A_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_VIVE_FOCUS3_B_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
				...
				.input = XRT_INPUT_VIVE_FOCUS3_SQUEEZE_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 2
			{ // binding_template 3
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/grip/touch",
				.localized_name = "Squeeze",
				.paths = { // array of paths
				...
				.input = XRT_INPUT_VIVE_FOCUS3_SQUEEZE_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 3
			{ // binding_template 4
				...
				.input = XRT_INPUT_VIVE_FOCUS3_SQUEEZE_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
			...
			{ // binding_template 8
				...
				.input = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 8
			{ // binding_template 9
				...
				.input = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 9
			{ // binding_template 10
				...
				.input = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK,
				.dpad_activate = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK,
				.output = 0,
			}, // /binding_template 10
			{ // binding_template 11
				.subaction_path = "/user/hand/right",
			...
			{ // binding_template 14
				...
				.input = XRT_INPUT_VIVE_FOCUS3_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 14
			{ // binding_template 15
				...
				.input = XRT_INPUT_VIVE_FOCUS3_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 15
			{ // binding_template 16
				...
				.input = XRT_INPUT_VIVE_FOCUS3_THUMBREST_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 16
			{ // binding_template 17
			...
			{ // binding_template 18
				...
				.input = XRT_INPUT_VIVE_FOCUS3_TRIGGER_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				...
				.input = XRT_INPUT_VIVE_FOCUS3_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
				...
				.input = XRT_INPUT_VIVE_FOCUS3_TRIGGER_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 20
			{ // binding_template 21
			...
			{ // binding_template 24
				...
				.input = XRT_INPUT_VIVE_FOCUS3_X_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 24
			{ // binding_template 25
				...
				.input = XRT_INPUT_VIVE_FOCUS3_Y_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 25
			{ // binding_template 26
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_VIVE_FOCUS3_HAPTIC,
			}, // /binding_template 26
			{ // binding_template 27
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 28
				...
				.input = XRT_INPUT_VIVE_FOCUS3_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 28
			{ // binding_template 29
			...
			{ // binding_template 30
				...
				.input = XRT_INPUT_VIVE_FOCUS3_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 30
			{ // binding_template 31
		...
		.dpads = (struct dpad_emulation[]){ // array of dpad_emulation
			{
				...
				.position = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK,
				.activate = XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK,
			},
			{
				.subaction_path = "/user/hand/right",
				.paths = {
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_htc_vive_focus3_controller_subpath,
		.dpad_path_fn = oxr_verify_htc_vive_focus3_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_htc_vive_focus3_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_htc_vive_focus3_controller_ext,
		.extension_name = "HTC_vive_focus3_controller_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_htc_vive_pro_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.openxr_version.promoted.major = 0,
		.openxr_version.promoted.minor = 0,
		.subpath_fn = oxr_verify_htc_vive_tracker_htcx_subpath,
		.dpad_path_fn = oxr_verify_htc_vive_tracker_htcx_dpad_path,
		.dpad_emulator_fn = oxr_verify_htc_vive_tracker_htcx_dpad_emulator,
		.ext_verify_fn = oxr_verify_htc_vive_tracker_htcx_ext,
		.extension_name = "HTCX_vive_tracker_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_khr_simple_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_PLUS_CONTROLLER,
		.path = "/interaction_profiles/meta/touch_controller_plus",
		.localized_name = "Meta Quest Touch Plus Controller",
		.steamvr_input_profile_path = "meta_touch_controller_plus_profile.json",
		.steamvr_controller_type = "monado_meta_touch_controller_plus",
		.binding_count = 48,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
				...
				.input = XRT_INPUT_TOUCH_PLUS_A_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 0
			{ // binding_template 1
				...
				.input = XRT_INPUT_TOUCH_PLUS_A_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 1
			{ // binding_template 2
				...
				.input = XRT_INPUT_TOUCH_PLUS_B_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 2
			{ // binding_template 3
				...
				.input = XRT_INPUT_TOUCH_PLUS_B_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 3
			{ // binding_template 4
				...
				.input = XRT_INPUT_TOUCH_PLUS_SQUEEZE_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 4
			{ // binding_template 5
			...
			{ // binding_template 6
				...
				.input = XRT_INPUT_TOUCH_PLUS_THUMBSTICK_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 6
			{ // binding_template 7
				...
				.input = XRT_INPUT_TOUCH_PLUS_THUMBSTICK_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 7
			{ // binding_template 8
				...
				.input = XRT_INPUT_TOUCH_PLUS_THUMBSTICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 8
			{ // binding_template 9
			...
			{ // binding_template 12
				...
				.input = XRT_INPUT_TOUCH_PLUS_MENU_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 12
			{ // binding_template 13
				...
				.input = XRT_INPUT_TOUCH_PLUS_SYSTEM_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 13
			{ // binding_template 14
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/thumb_meta",
				.localized_name = "Thumb",
				.paths = { // array of paths
					"/user/hand/left/input/thumb_meta/proximity_meta",
					"/user/hand/left/input/thumb_meta",
					NULL
				}, // /array of paths
			}, // /binding_template 14
			{ // binding_template 15
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/thumb_meta",
					NULL
				}, // /array of paths
			}, // /binding_template 15
			{ // binding_template 16
				...
				.input = XRT_INPUT_TOUCH_PLUS_THUMBREST_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 16
			{ // binding_template 17
			...
			{ // binding_template 18
				...
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
				...
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_VALUE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 19
			{ // binding_template 20
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/trigger/force",
				.localized_name = "Trigger",
				.paths = { // array of paths
				...
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_FORCE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 20
			{ // binding_template 21
			...
			{ // binding_template 30
				...
				.input = XRT_INPUT_TOUCH_PLUS_X_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 30
			{ // binding_template 31
				...
				.input = XRT_INPUT_TOUCH_PLUS_X_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 31
			{ // binding_template 32
				...
				.input = XRT_INPUT_TOUCH_PLUS_Y_CLICK,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 32
			{ // binding_template 33
				...
				.input = XRT_INPUT_TOUCH_PLUS_Y_TOUCH,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 33
			{ // binding_template 34
				...
				.input = 0,
				.dpad_activate = 0,
				.output = XRT_OUTPUT_NAME_TOUCH_PLUS_HAPTIC,
			}, // /binding_template 34
			{ // binding_template 35
				.subaction_path = "/user/hand/right",
				.steamvr_path = "/output/haptic",
			...
			{ // binding_template 36
				...
				.input = XRT_INPUT_TOUCH_PLUS_AIM_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 36
			{ // binding_template 37
			...
			{ // binding_template 38
				...
				.input = XRT_INPUT_TOUCH_PLUS_GRIP_POSE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 38
			{ // binding_template 39
		...
		.openxr_version.promoted.major = 0,
		.openxr_version.promoted.minor = 0,
		.subpath_fn = oxr_verify_meta_touch_controller_plus_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_controller_plus_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_controller_plus_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_controller_plus_ext,
		.extension_name = "META_touch_controller_plus",
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_CONTROLLER_QUEST_1_RIFT_S,
		.path = "/interaction_profiles/meta/touch_controller_quest_1_rift_s",
		.localized_name = "Meta Touch Controller (Rift S / Quest 1)",
		.steamvr_input_profile_path = "meta_touch_controller_quest_1_rift_s_profile.json",
		.steamvr_controller_type = "monado_meta_touch_controller_quest_1_rift_s",
		.binding_count = 40,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
			...
			{ // binding_template 14
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/thumb_resting_surfaces/proximity",
				.localized_name = "Thumb",
				.paths = { // array of paths
					"/user/hand/left/input/thumb_resting_surfaces/proximity",
					"/user/hand/left/input/thumb_resting_surfaces",
					NULL
				}, // /array of paths
			}, // /binding_template 14
			{ // binding_template 15
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/thumb_resting_surfaces",
					NULL
				}, // /array of paths
			}, // /binding_template 15
			{ // binding_template 16
			...
			{ // binding_template 18
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/trigger/proximity",
				.localized_name = "Trigger",
				.paths = { // array of paths
				...
				.input = XRT_INPUT_TOUCH_TRIGGER_PROXIMITY,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 18
			{ // binding_template 19
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_meta_touch_controller_quest_1_rift_s_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_controller_quest_1_rift_s_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_controller_quest_1_rift_s_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_controller_quest_1_rift_s_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_CONTROLLER_QUEST_2,
		.path = "/interaction_profiles/meta/touch_controller_quest_2",
		.localized_name = "Meta Touch Controller (Quest 2)",
		.steamvr_input_profile_path = "meta_touch_controller_quest_2_profile.json",
		.steamvr_controller_type = "monado_meta_touch_controller_quest_2",
		.binding_count = 42,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_meta_touch_controller_quest_2_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_controller_quest_2_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_controller_quest_2_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_controller_quest_2_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_CONTROLLER_RIFT_CV1,
		.path = "/interaction_profiles/meta/touch_controller_rift_cv1",
		.localized_name = "Meta Touch Controller (Rift CV1)",
		.steamvr_input_profile_path = "meta_touch_controller_rift_cv1_profile.json",
		.steamvr_controller_type = "monado_meta_touch_controller_rift_cv1",
		.binding_count = 42,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_meta_touch_controller_rift_cv1_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_controller_rift_cv1_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_controller_rift_cv1_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_controller_rift_cv1_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_PLUS_CONTROLLER,
		.path = "/interaction_profiles/meta/touch_plus_controller",
		.localized_name = "Meta Touch Plus Controller",
		.steamvr_input_profile_path = "meta_touch_plus_controller_profile.json",
		.steamvr_controller_type = "monado_meta_touch_plus_controller",
		.binding_count = 48,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
			...
			{ // binding_template 21
				...
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_PROXIMITY,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 21
			{ // binding_template 22
			...
			{ // binding_template 26
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/trigger_curl/value",
				.localized_name = "Trigger",
				.paths = { // array of paths
					"/user/hand/left/input/trigger_curl/value",
					"/user/hand/left/input/trigger_curl",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 26
			{ // binding_template 27
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/trigger_curl",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL,
				.dpad_activate = 0,
			...
			{ // binding_template 28
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/trigger_slide/value",
				.localized_name = "Trigger",
				.paths = { // array of paths
					"/user/hand/left/input/trigger_slide/value",
					"/user/hand/left/input/trigger_slide",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 28
			{ // binding_template 29
				...
				.paths = { // array of paths
					...
					"/user/hand/right/input/trigger_slide",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE,
				.dpad_activate = 0,
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_meta_touch_plus_controller_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_plus_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_plus_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_plus_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		.name = XRT_DEVICE_TOUCH_PRO_CONTROLLER,
		.path = "/interaction_profiles/meta/touch_pro_controller",
		.localized_name = "Meta Touch Pro Controller",
		.steamvr_input_profile_path = "meta_touch_pro_controller_profile.json",
		.steamvr_controller_type = "monado_meta_touch_pro_controller",
		.binding_count = 54,
		.bindings = (struct binding_template[]){ // array of binding_template
			{ // binding_template 0
				.subaction_path = "/user/hand/right",
			...
			{ // binding_template 13
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/input/stylus/force",
				.localized_name = "Stylus",
				.paths = { // array of paths
					"/user/hand/left/input/stylus/force",
					"/user/hand/left/input/stylus",
					NULL
				}, // /array of paths
				.input = XRT_INPUT_TOUCH_PRO_STYLUS_FORCE,
				.dpad_activate = 0,
			...
			{ // binding_template 24
				...
				.input = XRT_INPUT_TOUCH_PRO_TRIGGER_PROXIMITY,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 24
			{ // binding_template 25
			...
			{ // binding_template 28
				...
				.input = XRT_INPUT_TOUCH_PRO_TRIGGER_CURL,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 28
			{ // binding_template 29
			...
			{ // binding_template 30
				...
				.input = XRT_INPUT_TOUCH_PRO_TRIGGER_SLIDE,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 30
			{ // binding_template 31
			...
			{ // binding_template 38
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/output/haptic_thumb",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/left/output/haptic_thumb/haptic",
			...
			{ // binding_template 39
				...
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/right/output/haptic_thumb/haptic",
			...
			{ // binding_template 40
				.subaction_path = "/user/hand/left",
				.steamvr_path = "/output/haptic_trigger",
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/left/output/haptic_trigger/haptic",
			...
			{ // binding_template 41
				...
				.localized_name = "Haptic",
				.paths = { // array of paths
					"/user/hand/right/output/haptic_trigger/haptic",
		...
		.openxr_version.promoted.major = 1,
		.openxr_version.promoted.minor = 1,
		.subpath_fn = oxr_verify_meta_touch_pro_controller_subpath,
		.dpad_path_fn = oxr_verify_meta_touch_pro_controller_dpad_path,
		.dpad_emulator_fn = oxr_verify_meta_touch_pro_controller_dpad_emulator,
		.ext_verify_fn = oxr_verify_meta_touch_pro_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_microsoft_hand_interaction_ext,
		.extension_name = "MSFT_hand_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_microsoft_motion_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_microsoft_xbox_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_ml_ml2_controller_ext,
		.extension_name = "ML_ml2_controller_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_mndx_ball_on_a_stick_controller_ext,
		.extension_name = "MNDX_ball_on_a_stick_controller",
	}, // /profile_template
	{ // profile_template
		...
		.openxr_version.promoted.major = 0,
		.openxr_version.promoted.minor = 0,
		.subpath_fn = oxr_verify_mndx_hydra_subpath,
		.dpad_path_fn = oxr_verify_mndx_hydra_dpad_path,
		.dpad_emulator_fn = oxr_verify_mndx_hydra_dpad_emulator,
		.ext_verify_fn = oxr_verify_mndx_hydra_ext,
		.extension_name = "MNDX_hydra",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_oculus_go_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.bindings = (struct binding_template[]){ // array of binding_template
			...
			{ // binding_template 14
				...
				.input = XRT_INPUT_TOUCH_THUMB_PROXIMITY,
				.dpad_activate = 0,
				.output = 0,
			}, // /binding_template 14
			{ // binding_template 15
		...
		.ext_verify_fn = oxr_verify_oculus_touch_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_oppo_mr_controller_oppo_ext,
		.extension_name = "OPPO_controller_interaction",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_samsung_odyssey_controller_ext,
		.extension_name = "EXT_samsung_odyssey_controller",
	}, // /profile_template
	{ // profile_template
		...
		.ext_verify_fn = oxr_verify_valve_index_controller_ext,
		.extension_name = NULL,
	}, // /profile_template
...
xrt_input_name_string(enum xrt_input_name input)
{
	...
	case XRT_INPUT_PICO4_AIM_POSE: return "XRT_INPUT_PICO4_AIM_POSE";
	case XRT_INPUT_PICO4_A_CLICK: return "XRT_INPUT_PICO4_A_CLICK";
	case XRT_INPUT_PICO4_A_TOUCH: return "XRT_INPUT_PICO4_A_TOUCH";
	case XRT_INPUT_PICO4_B_CLICK: return "XRT_INPUT_PICO4_B_CLICK";
	case XRT_INPUT_PICO4_B_TOUCH: return "XRT_INPUT_PICO4_B_TOUCH";
	case XRT_INPUT_PICO4_GRIP_POSE: return "XRT_INPUT_PICO4_GRIP_POSE";
	case XRT_INPUT_PICO4_MENU_CLICK: return "XRT_INPUT_PICO4_MENU_CLICK";
	case XRT_INPUT_PICO4_SQUEEZE_CLICK: return "XRT_INPUT_PICO4_SQUEEZE_CLICK";
	case XRT_INPUT_PICO4_SQUEEZE_VALUE: return "XRT_INPUT_PICO4_SQUEEZE_VALUE";
	case XRT_INPUT_PICO4_SYSTEM_CLICK: return "XRT_INPUT_PICO4_SYSTEM_CLICK";
	case XRT_INPUT_PICO4_THUMBSTICK: return "XRT_INPUT_PICO4_THUMBSTICK";
	case XRT_INPUT_PICO4_THUMBSTICK_CLICK: return "XRT_INPUT_PICO4_THUMBSTICK_CLICK";
	case XRT_INPUT_PICO4_THUMBSTICK_TOUCH: return "XRT_INPUT_PICO4_THUMBSTICK_TOUCH";
	case XRT_INPUT_PICO4_TRIGGER_CLICK: return "XRT_INPUT_PICO4_TRIGGER_CLICK";
	case XRT_INPUT_PICO4_TRIGGER_TOUCH: return "XRT_INPUT_PICO4_TRIGGER_TOUCH";
	case XRT_INPUT_PICO4_TRIGGER_VALUE: return "XRT_INPUT_PICO4_TRIGGER_VALUE";
	case XRT_INPUT_PICO4_X_CLICK: return "XRT_INPUT_PICO4_X_CLICK";
	case XRT_INPUT_PICO4_X_TOUCH: return "XRT_INPUT_PICO4_X_TOUCH";
	case XRT_INPUT_PICO4_Y_CLICK: return "XRT_INPUT_PICO4_Y_CLICK";
	case XRT_INPUT_PICO4_Y_TOUCH: return "XRT_INPUT_PICO4_Y_TOUCH";
	case XRT_INPUT_PICO_G3_AIM_POSE: return "XRT_INPUT_PICO_G3_AIM_POSE";
	case XRT_INPUT_PICO_G3_GRIP_POSE: return "XRT_INPUT_PICO_G3_GRIP_POSE";
	case XRT_INPUT_PICO_G3_MENU_CLICK: return "XRT_INPUT_PICO_G3_MENU_CLICK";
	case XRT_INPUT_PICO_G3_THUMBSTICK: return "XRT_INPUT_PICO_G3_THUMBSTICK";
	case XRT_INPUT_PICO_G3_THUMBSTICK_CLICK: return "XRT_INPUT_PICO_G3_THUMBSTICK_CLICK";
	case XRT_INPUT_PICO_G3_TRIGGER_CLICK: return "XRT_INPUT_PICO_G3_TRIGGER_CLICK";
	case XRT_INPUT_PICO_G3_TRIGGER_VALUE: return "XRT_INPUT_PICO_G3_TRIGGER_VALUE";
	case XRT_INPUT_PICO_NEO3_AIM_POSE: return "XRT_INPUT_PICO_NEO3_AIM_POSE";
	case XRT_INPUT_PICO_NEO3_A_CLICK: return "XRT_INPUT_PICO_NEO3_A_CLICK";
	case XRT_INPUT_PICO_NEO3_A_TOUCH: return "XRT_INPUT_PICO_NEO3_A_TOUCH";
	case XRT_INPUT_PICO_NEO3_B_CLICK: return "XRT_INPUT_PICO_NEO3_B_CLICK";
	case XRT_INPUT_PICO_NEO3_B_TOUCH: return "XRT_INPUT_PICO_NEO3_B_TOUCH";
	case XRT_INPUT_PICO_NEO3_GRIP_POSE: return "XRT_INPUT_PICO_NEO3_GRIP_POSE";
	case XRT_INPUT_PICO_NEO3_MENU_CLICK: return "XRT_INPUT_PICO_NEO3_MENU_CLICK";
	case XRT_INPUT_PICO_NEO3_SQUEEZE_CLICK: return "XRT_INPUT_PICO_NEO3_SQUEEZE_CLICK";
	case XRT_INPUT_PICO_NEO3_SQUEEZE_VALUE: return "XRT_INPUT_PICO_NEO3_SQUEEZE_VALUE";
	case XRT_INPUT_PICO_NEO3_SYSTEM_CLICK: return "XRT_INPUT_PICO_NEO3_SYSTEM_CLICK";
	case XRT_INPUT_PICO_NEO3_THUMBSTICK: return "XRT_INPUT_PICO_NEO3_THUMBSTICK";
	case XRT_INPUT_PICO_NEO3_THUMBSTICK_CLICK: return "XRT_INPUT_PICO_NEO3_THUMBSTICK_CLICK";
	case XRT_INPUT_PICO_NEO3_THUMBSTICK_TOUCH: return "XRT_INPUT_PICO_NEO3_THUMBSTICK_TOUCH";
	case XRT_INPUT_PICO_NEO3_TRIGGER_CLICK: return "XRT_INPUT_PICO_NEO3_TRIGGER_CLICK";
	case XRT_INPUT_PICO_NEO3_TRIGGER_TOUCH: return "XRT_INPUT_PICO_NEO3_TRIGGER_TOUCH";
	case XRT_INPUT_PICO_NEO3_TRIGGER_VALUE: return "XRT_INPUT_PICO_NEO3_TRIGGER_VALUE";
	case XRT_INPUT_PICO_NEO3_X_CLICK: return "XRT_INPUT_PICO_NEO3_X_CLICK";
	case XRT_INPUT_PICO_NEO3_X_TOUCH: return "XRT_INPUT_PICO_NEO3_X_TOUCH";
	case XRT_INPUT_PICO_NEO3_Y_CLICK: return "XRT_INPUT_PICO_NEO3_Y_CLICK";
	case XRT_INPUT_PICO_NEO3_Y_TOUCH: return "XRT_INPUT_PICO_NEO3_Y_TOUCH";
	...
	case XRT_INPUT_TOUCH_PLUS_AIM_POSE: return "XRT_INPUT_TOUCH_PLUS_AIM_POSE";
	case XRT_INPUT_TOUCH_PLUS_A_CLICK: return "XRT_INPUT_TOUCH_PLUS_A_CLICK";
	case XRT_INPUT_TOUCH_PLUS_A_TOUCH: return "XRT_INPUT_TOUCH_PLUS_A_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_B_CLICK: return "XRT_INPUT_TOUCH_PLUS_B_CLICK";
	case XRT_INPUT_TOUCH_PLUS_B_TOUCH: return "XRT_INPUT_TOUCH_PLUS_B_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_GRIP_POSE: return "XRT_INPUT_TOUCH_PLUS_GRIP_POSE";
	case XRT_INPUT_TOUCH_PLUS_MENU_CLICK: return "XRT_INPUT_TOUCH_PLUS_MENU_CLICK";
	case XRT_INPUT_TOUCH_PLUS_SQUEEZE_VALUE: return "XRT_INPUT_TOUCH_PLUS_SQUEEZE_VALUE";
	case XRT_INPUT_TOUCH_PLUS_SYSTEM_CLICK: return "XRT_INPUT_TOUCH_PLUS_SYSTEM_CLICK";
	case XRT_INPUT_TOUCH_PLUS_THUMBREST_TOUCH: return "XRT_INPUT_TOUCH_PLUS_THUMBREST_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_THUMBSTICK: return "XRT_INPUT_TOUCH_PLUS_THUMBSTICK";
	case XRT_INPUT_TOUCH_PLUS_THUMBSTICK_CLICK: return "XRT_INPUT_TOUCH_PLUS_THUMBSTICK_CLICK";
	case XRT_INPUT_TOUCH_PLUS_THUMBSTICK_TOUCH: return "XRT_INPUT_TOUCH_PLUS_THUMBSTICK_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_FORCE: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_FORCE";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_PROXIMITY: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_PROXIMITY";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_TOUCH: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_TRIGGER_VALUE: return "XRT_INPUT_TOUCH_PLUS_TRIGGER_VALUE";
	case XRT_INPUT_TOUCH_PLUS_X_CLICK: return "XRT_INPUT_TOUCH_PLUS_X_CLICK";
	case XRT_INPUT_TOUCH_PLUS_X_TOUCH: return "XRT_INPUT_TOUCH_PLUS_X_TOUCH";
	case XRT_INPUT_TOUCH_PLUS_Y_CLICK: return "XRT_INPUT_TOUCH_PLUS_Y_CLICK";
	case XRT_INPUT_TOUCH_PLUS_Y_TOUCH: return "XRT_INPUT_TOUCH_PLUS_Y_TOUCH";
	case XRT_INPUT_TOUCH_PRO_AIM_POSE: return "XRT_INPUT_TOUCH_PRO_AIM_POSE";
	case XRT_INPUT_TOUCH_PRO_A_CLICK: return "XRT_INPUT_TOUCH_PRO_A_CLICK";
	case XRT_INPUT_TOUCH_PRO_A_TOUCH: return "XRT_INPUT_TOUCH_PRO_A_TOUCH";
	case XRT_INPUT_TOUCH_PRO_B_CLICK: return "XRT_INPUT_TOUCH_PRO_B_CLICK";
	case XRT_INPUT_TOUCH_PRO_B_TOUCH: return "XRT_INPUT_TOUCH_PRO_B_TOUCH";
	case XRT_INPUT_TOUCH_PRO_GRIP_POSE: return "XRT_INPUT_TOUCH_PRO_GRIP_POSE";
	case XRT_INPUT_TOUCH_PRO_MENU_CLICK: return "XRT_INPUT_TOUCH_PRO_MENU_CLICK";
	case XRT_INPUT_TOUCH_PRO_SQUEEZE_VALUE: return "XRT_INPUT_TOUCH_PRO_SQUEEZE_VALUE";
	case XRT_INPUT_TOUCH_PRO_STYLUS_FORCE: return "XRT_INPUT_TOUCH_PRO_STYLUS_FORCE";
	case XRT_INPUT_TOUCH_PRO_SYSTEM_CLICK: return "XRT_INPUT_TOUCH_PRO_SYSTEM_CLICK";
	case XRT_INPUT_TOUCH_PRO_THUMBREST_FORCE: return "XRT_INPUT_TOUCH_PRO_THUMBREST_FORCE";
	case XRT_INPUT_TOUCH_PRO_THUMBREST_TOUCH: return "XRT_INPUT_TOUCH_PRO_THUMBREST_TOUCH";
	case XRT_INPUT_TOUCH_PRO_THUMBSTICK: return "XRT_INPUT_TOUCH_PRO_THUMBSTICK";
	case XRT_INPUT_TOUCH_PRO_THUMBSTICK_CLICK: return "XRT_INPUT_TOUCH_PRO_THUMBSTICK_CLICK";
	case XRT_INPUT_TOUCH_PRO_THUMBSTICK_TOUCH: return "XRT_INPUT_TOUCH_PRO_THUMBSTICK_TOUCH";
	case XRT_INPUT_TOUCH_PRO_TRIGGER_CURL: return "XRT_INPUT_TOUCH_PRO_TRIGGER_CURL";
	case XRT_INPUT_TOUCH_PRO_TRIGGER_PROXIMITY: return "XRT_INPUT_TOUCH_PRO_TRIGGER_PROXIMITY";
	case XRT_INPUT_TOUCH_PRO_TRIGGER_SLIDE: return "XRT_INPUT_TOUCH_PRO_TRIGGER_SLIDE";
	case XRT_INPUT_TOUCH_PRO_TRIGGER_TOUCH: return "XRT_INPUT_TOUCH_PRO_TRIGGER_TOUCH";
	case XRT_INPUT_TOUCH_PRO_TRIGGER_VALUE: return "XRT_INPUT_TOUCH_PRO_TRIGGER_VALUE";
	case XRT_INPUT_TOUCH_PRO_X_CLICK: return "XRT_INPUT_TOUCH_PRO_X_CLICK";
	case XRT_INPUT_TOUCH_PRO_X_TOUCH: return "XRT_INPUT_TOUCH_PRO_X_TOUCH";
	case XRT_INPUT_TOUCH_PRO_Y_CLICK: return "XRT_INPUT_TOUCH_PRO_Y_CLICK";
	case XRT_INPUT_TOUCH_PRO_Y_TOUCH: return "XRT_INPUT_TOUCH_PRO_Y_TOUCH";
	...
	case XRT_INPUT_TOUCH_THUMB_PROXIMITY: return "XRT_INPUT_TOUCH_THUMB_PROXIMITY";
	case XRT_INPUT_TOUCH_TRIGGER_PROXIMITY: return "XRT_INPUT_TOUCH_TRIGGER_PROXIMITY";
	...
	case XRT_INPUT_VIVE_COSMOS_AIM_POSE: return "XRT_INPUT_VIVE_COSMOS_AIM_POSE";
	case XRT_INPUT_VIVE_COSMOS_A_CLICK: return "XRT_INPUT_VIVE_COSMOS_A_CLICK";
	case XRT_INPUT_VIVE_COSMOS_B_CLICK: return "XRT_INPUT_VIVE_COSMOS_B_CLICK";
	case XRT_INPUT_VIVE_COSMOS_GRIP_POSE: return "XRT_INPUT_VIVE_COSMOS_GRIP_POSE";
	case XRT_INPUT_VIVE_COSMOS_MENU_CLICK: return "XRT_INPUT_VIVE_COSMOS_MENU_CLICK";
	case XRT_INPUT_VIVE_COSMOS_SHOULDER_CLICK: return "XRT_INPUT_VIVE_COSMOS_SHOULDER_CLICK";
	case XRT_INPUT_VIVE_COSMOS_SQUEEZE_CLICK: return "XRT_INPUT_VIVE_COSMOS_SQUEEZE_CLICK";
	case XRT_INPUT_VIVE_COSMOS_SYSTEM_CLICK: return "XRT_INPUT_VIVE_COSMOS_SYSTEM_CLICK";
	case XRT_INPUT_VIVE_COSMOS_THUMBSTICK: return "XRT_INPUT_VIVE_COSMOS_THUMBSTICK";
	case XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK: return "XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK";
	case XRT_INPUT_VIVE_COSMOS_THUMBSTICK_TOUCH: return "XRT_INPUT_VIVE_COSMOS_THUMBSTICK_TOUCH";
	case XRT_INPUT_VIVE_COSMOS_TRIGGER_CLICK: return "XRT_INPUT_VIVE_COSMOS_TRIGGER_CLICK";
	case XRT_INPUT_VIVE_COSMOS_TRIGGER_VALUE: return "XRT_INPUT_VIVE_COSMOS_TRIGGER_VALUE";
	case XRT_INPUT_VIVE_COSMOS_X_CLICK: return "XRT_INPUT_VIVE_COSMOS_X_CLICK";
	case XRT_INPUT_VIVE_COSMOS_Y_CLICK: return "XRT_INPUT_VIVE_COSMOS_Y_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_AIM_POSE: return "XRT_INPUT_VIVE_FOCUS3_AIM_POSE";
	case XRT_INPUT_VIVE_FOCUS3_A_CLICK: return "XRT_INPUT_VIVE_FOCUS3_A_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_B_CLICK: return "XRT_INPUT_VIVE_FOCUS3_B_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_GRIP_POSE: return "XRT_INPUT_VIVE_FOCUS3_GRIP_POSE";
	case XRT_INPUT_VIVE_FOCUS3_MENU_CLICK: return "XRT_INPUT_VIVE_FOCUS3_MENU_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_SQUEEZE_CLICK: return "XRT_INPUT_VIVE_FOCUS3_SQUEEZE_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_SQUEEZE_TOUCH: return "XRT_INPUT_VIVE_FOCUS3_SQUEEZE_TOUCH";
	case XRT_INPUT_VIVE_FOCUS3_SQUEEZE_VALUE: return "XRT_INPUT_VIVE_FOCUS3_SQUEEZE_VALUE";
	case XRT_INPUT_VIVE_FOCUS3_SYSTEM_CLICK: return "XRT_INPUT_VIVE_FOCUS3_SYSTEM_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_THUMBREST_TOUCH: return "XRT_INPUT_VIVE_FOCUS3_THUMBREST_TOUCH";
	case XRT_INPUT_VIVE_FOCUS3_THUMBSTICK: return "XRT_INPUT_VIVE_FOCUS3_THUMBSTICK";
	case XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK: return "XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_TOUCH: return "XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_TOUCH";
	case XRT_INPUT_VIVE_FOCUS3_TRIGGER_CLICK: return "XRT_INPUT_VIVE_FOCUS3_TRIGGER_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_TRIGGER_TOUCH: return "XRT_INPUT_VIVE_FOCUS3_TRIGGER_TOUCH";
	case XRT_INPUT_VIVE_FOCUS3_TRIGGER_VALUE: return "XRT_INPUT_VIVE_FOCUS3_TRIGGER_VALUE";
	case XRT_INPUT_VIVE_FOCUS3_X_CLICK: return "XRT_INPUT_VIVE_FOCUS3_X_CLICK";
	case XRT_INPUT_VIVE_FOCUS3_Y_CLICK: return "XRT_INPUT_VIVE_FOCUS3_Y_CLICK";
...
xrt_input_name_enum(const char *input)
{
	...
	if(strcmp("XRT_INPUT_PICO4_AIM_POSE", input) == 0) return XRT_INPUT_PICO4_AIM_POSE;
	if(strcmp("XRT_INPUT_PICO4_A_CLICK", input) == 0) return XRT_INPUT_PICO4_A_CLICK;
	if(strcmp("XRT_INPUT_PICO4_A_TOUCH", input) == 0) return XRT_INPUT_PICO4_A_TOUCH;
	if(strcmp("XRT_INPUT_PICO4_B_CLICK", input) == 0) return XRT_INPUT_PICO4_B_CLICK;
	if(strcmp("XRT_INPUT_PICO4_B_TOUCH", input) == 0) return XRT_INPUT_PICO4_B_TOUCH;
	if(strcmp("XRT_INPUT_PICO4_GRIP_POSE", input) == 0) return XRT_INPUT_PICO4_GRIP_POSE;
	if(strcmp("XRT_INPUT_PICO4_MENU_CLICK", input) == 0) return XRT_INPUT_PICO4_MENU_CLICK;
	if(strcmp("XRT_INPUT_PICO4_SQUEEZE_CLICK", input) == 0) return XRT_INPUT_PICO4_SQUEEZE_CLICK;
	if(strcmp("XRT_INPUT_PICO4_SQUEEZE_VALUE", input) == 0) return XRT_INPUT_PICO4_SQUEEZE_VALUE;
	if(strcmp("XRT_INPUT_PICO4_SYSTEM_CLICK", input) == 0) return XRT_INPUT_PICO4_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_PICO4_THUMBSTICK", input) == 0) return XRT_INPUT_PICO4_THUMBSTICK;
	if(strcmp("XRT_INPUT_PICO4_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_PICO4_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_PICO4_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_PICO4_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_PICO4_TRIGGER_CLICK", input) == 0) return XRT_INPUT_PICO4_TRIGGER_CLICK;
	if(strcmp("XRT_INPUT_PICO4_TRIGGER_TOUCH", input) == 0) return XRT_INPUT_PICO4_TRIGGER_TOUCH;
	if(strcmp("XRT_INPUT_PICO4_TRIGGER_VALUE", input) == 0) return XRT_INPUT_PICO4_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_PICO4_X_CLICK", input) == 0) return XRT_INPUT_PICO4_X_CLICK;
	if(strcmp("XRT_INPUT_PICO4_X_TOUCH", input) == 0) return XRT_INPUT_PICO4_X_TOUCH;
	if(strcmp("XRT_INPUT_PICO4_Y_CLICK", input) == 0) return XRT_INPUT_PICO4_Y_CLICK;
	if(strcmp("XRT_INPUT_PICO4_Y_TOUCH", input) == 0) return XRT_INPUT_PICO4_Y_TOUCH;
	if(strcmp("XRT_INPUT_PICO_G3_AIM_POSE", input) == 0) return XRT_INPUT_PICO_G3_AIM_POSE;
	if(strcmp("XRT_INPUT_PICO_G3_GRIP_POSE", input) == 0) return XRT_INPUT_PICO_G3_GRIP_POSE;
	if(strcmp("XRT_INPUT_PICO_G3_MENU_CLICK", input) == 0) return XRT_INPUT_PICO_G3_MENU_CLICK;
	if(strcmp("XRT_INPUT_PICO_G3_THUMBSTICK", input) == 0) return XRT_INPUT_PICO_G3_THUMBSTICK;
	if(strcmp("XRT_INPUT_PICO_G3_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_PICO_G3_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_PICO_G3_TRIGGER_CLICK", input) == 0) return XRT_INPUT_PICO_G3_TRIGGER_CLICK;
	if(strcmp("XRT_INPUT_PICO_G3_TRIGGER_VALUE", input) == 0) return XRT_INPUT_PICO_G3_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_PICO_NEO3_AIM_POSE", input) == 0) return XRT_INPUT_PICO_NEO3_AIM_POSE;
	if(strcmp("XRT_INPUT_PICO_NEO3_A_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_A_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_A_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_A_TOUCH;
	if(strcmp("XRT_INPUT_PICO_NEO3_B_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_B_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_B_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_B_TOUCH;
	if(strcmp("XRT_INPUT_PICO_NEO3_GRIP_POSE", input) == 0) return XRT_INPUT_PICO_NEO3_GRIP_POSE;
	if(strcmp("XRT_INPUT_PICO_NEO3_MENU_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_MENU_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_SQUEEZE_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_SQUEEZE_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_SQUEEZE_VALUE", input) == 0) return XRT_INPUT_PICO_NEO3_SQUEEZE_VALUE;
	if(strcmp("XRT_INPUT_PICO_NEO3_SYSTEM_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_THUMBSTICK", input) == 0) return XRT_INPUT_PICO_NEO3_THUMBSTICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_PICO_NEO3_TRIGGER_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_TRIGGER_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_TRIGGER_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_TRIGGER_TOUCH;
	if(strcmp("XRT_INPUT_PICO_NEO3_TRIGGER_VALUE", input) == 0) return XRT_INPUT_PICO_NEO3_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_PICO_NEO3_X_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_X_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_X_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_X_TOUCH;
	if(strcmp("XRT_INPUT_PICO_NEO3_Y_CLICK", input) == 0) return XRT_INPUT_PICO_NEO3_Y_CLICK;
	if(strcmp("XRT_INPUT_PICO_NEO3_Y_TOUCH", input) == 0) return XRT_INPUT_PICO_NEO3_Y_TOUCH;
	...
	if(strcmp("XRT_INPUT_TOUCH_PLUS_AIM_POSE", input) == 0) return XRT_INPUT_TOUCH_PLUS_AIM_POSE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_A_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_A_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_A_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_A_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_B_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_B_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_B_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_B_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_GRIP_POSE", input) == 0) return XRT_INPUT_TOUCH_PLUS_GRIP_POSE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_MENU_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_MENU_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_SQUEEZE_VALUE", input) == 0) return XRT_INPUT_TOUCH_PLUS_SQUEEZE_VALUE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_SYSTEM_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_THUMBREST_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_THUMBREST_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_THUMBSTICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_THUMBSTICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_CURL;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_FORCE", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_FORCE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_PROXIMITY", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_PROXIMITY;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_SLIDE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_TRIGGER_VALUE", input) == 0) return XRT_INPUT_TOUCH_PLUS_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_X_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_X_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_X_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_X_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_Y_CLICK", input) == 0) return XRT_INPUT_TOUCH_PLUS_Y_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PLUS_Y_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PLUS_Y_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_AIM_POSE", input) == 0) return XRT_INPUT_TOUCH_PRO_AIM_POSE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_A_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_A_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_A_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_A_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_B_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_B_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_B_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_B_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_GRIP_POSE", input) == 0) return XRT_INPUT_TOUCH_PRO_GRIP_POSE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_MENU_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_MENU_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_SQUEEZE_VALUE", input) == 0) return XRT_INPUT_TOUCH_PRO_SQUEEZE_VALUE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_STYLUS_FORCE", input) == 0) return XRT_INPUT_TOUCH_PRO_STYLUS_FORCE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_SYSTEM_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_THUMBREST_FORCE", input) == 0) return XRT_INPUT_TOUCH_PRO_THUMBREST_FORCE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_THUMBREST_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_THUMBREST_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_THUMBSTICK", input) == 0) return XRT_INPUT_TOUCH_PRO_THUMBSTICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_TRIGGER_CURL", input) == 0) return XRT_INPUT_TOUCH_PRO_TRIGGER_CURL;
	if(strcmp("XRT_INPUT_TOUCH_PRO_TRIGGER_PROXIMITY", input) == 0) return XRT_INPUT_TOUCH_PRO_TRIGGER_PROXIMITY;
	if(strcmp("XRT_INPUT_TOUCH_PRO_TRIGGER_SLIDE", input) == 0) return XRT_INPUT_TOUCH_PRO_TRIGGER_SLIDE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_TRIGGER_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_TRIGGER_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_TRIGGER_VALUE", input) == 0) return XRT_INPUT_TOUCH_PRO_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_TOUCH_PRO_X_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_X_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_X_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_X_TOUCH;
	if(strcmp("XRT_INPUT_TOUCH_PRO_Y_CLICK", input) == 0) return XRT_INPUT_TOUCH_PRO_Y_CLICK;
	if(strcmp("XRT_INPUT_TOUCH_PRO_Y_TOUCH", input) == 0) return XRT_INPUT_TOUCH_PRO_Y_TOUCH;
	...
	if(strcmp("XRT_INPUT_TOUCH_THUMB_PROXIMITY", input) == 0) return XRT_INPUT_TOUCH_THUMB_PROXIMITY;
	if(strcmp("XRT_INPUT_TOUCH_TRIGGER_PROXIMITY", input) == 0) return XRT_INPUT_TOUCH_TRIGGER_PROXIMITY;
	...
	if(strcmp("XRT_INPUT_VIVE_COSMOS_AIM_POSE", input) == 0) return XRT_INPUT_VIVE_COSMOS_AIM_POSE;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_A_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_A_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_B_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_B_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_GRIP_POSE", input) == 0) return XRT_INPUT_VIVE_COSMOS_GRIP_POSE;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_MENU_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_MENU_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_SHOULDER_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_SHOULDER_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_SQUEEZE_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_SQUEEZE_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_SYSTEM_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_THUMBSTICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_THUMBSTICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_VIVE_COSMOS_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_TRIGGER_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_TRIGGER_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_TRIGGER_VALUE", input) == 0) return XRT_INPUT_VIVE_COSMOS_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_X_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_X_CLICK;
	if(strcmp("XRT_INPUT_VIVE_COSMOS_Y_CLICK", input) == 0) return XRT_INPUT_VIVE_COSMOS_Y_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_AIM_POSE", input) == 0) return XRT_INPUT_VIVE_FOCUS3_AIM_POSE;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_A_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_A_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_B_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_B_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_GRIP_POSE", input) == 0) return XRT_INPUT_VIVE_FOCUS3_GRIP_POSE;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_MENU_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_MENU_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_SQUEEZE_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_SQUEEZE_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_SQUEEZE_TOUCH", input) == 0) return XRT_INPUT_VIVE_FOCUS3_SQUEEZE_TOUCH;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_SQUEEZE_VALUE", input) == 0) return XRT_INPUT_VIVE_FOCUS3_SQUEEZE_VALUE;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_SYSTEM_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_SYSTEM_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_THUMBREST_TOUCH", input) == 0) return XRT_INPUT_VIVE_FOCUS3_THUMBREST_TOUCH;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_THUMBSTICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_THUMBSTICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_TOUCH", input) == 0) return XRT_INPUT_VIVE_FOCUS3_THUMBSTICK_TOUCH;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_TRIGGER_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_TRIGGER_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_TRIGGER_TOUCH", input) == 0) return XRT_INPUT_VIVE_FOCUS3_TRIGGER_TOUCH;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_TRIGGER_VALUE", input) == 0) return XRT_INPUT_VIVE_FOCUS3_TRIGGER_VALUE;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_X_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_X_CLICK;
	if(strcmp("XRT_INPUT_VIVE_FOCUS3_Y_CLICK", input) == 0) return XRT_INPUT_VIVE_FOCUS3_Y_CLICK;
...
xrt_output_name_string(enum xrt_output_name output)
{
	...
	case XRT_OUTPUT_NAME_PICO4_HAPTIC: return "XRT_OUTPUT_NAME_PICO4_HAPTIC";
	case XRT_OUTPUT_NAME_PICO_NEO3_HAPTIC: return "XRT_OUTPUT_NAME_PICO_NEO3_HAPTIC";
	...
	case XRT_OUTPUT_NAME_TOUCH_PLUS_HAPTIC: return "XRT_OUTPUT_NAME_TOUCH_PLUS_HAPTIC";
	case XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC: return "XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC";
	case XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_THUMB: return "XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_THUMB";
	case XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_TRIGGER: return "XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_TRIGGER";
	case XRT_OUTPUT_NAME_VIVE_COSMOS_HAPTIC: return "XRT_OUTPUT_NAME_VIVE_COSMOS_HAPTIC";
	case XRT_OUTPUT_NAME_VIVE_FOCUS3_HAPTIC: return "XRT_OUTPUT_NAME_VIVE_FOCUS3_HAPTIC";
...
xrt_output_name_enum(const char *output)
{
	...
	if(strcmp("XRT_OUTPUT_NAME_PICO4_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_PICO4_HAPTIC;
	if(strcmp("XRT_OUTPUT_NAME_PICO_NEO3_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_PICO_NEO3_HAPTIC;
	...
	if(strcmp("XRT_OUTPUT_NAME_TOUCH_PLUS_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_TOUCH_PLUS_HAPTIC;
	if(strcmp("XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC;
	if(strcmp("XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_THUMB", output) == 0) return XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_THUMB;
	if(strcmp("XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_TRIGGER", output) == 0) return XRT_OUTPUT_NAME_TOUCH_PRO_HAPTIC_TRIGGER;
	if(strcmp("XRT_OUTPUT_NAME_VIVE_COSMOS_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_VIVE_COSMOS_HAPTIC;
	if(strcmp("XRT_OUTPUT_NAME_VIVE_FOCUS3_HAPTIC", output) == 0) return XRT_OUTPUT_NAME_VIVE_FOCUS3_HAPTIC;
...
static const struct oxr_bindings_path_cache internal_path_cache = {
	.path_cache = {
		{
			.path_cache = &profile_templates[0].path_cache,
			.path_cache_name = &profile_templates[0].path,
		},

		{
			.path_cache = &profile_templates[1].path_cache,
			.path_cache_name = &profile_templates[1].path,
		},

		{
			.path_cache = &profile_templates[2].path_cache,
			.path_cache_name = &profile_templates[2].path,
		},

		{
			.path_cache = &profile_templates[3].path_cache,
			.path_cache_name = &profile_templates[3].path,
		},

		{
			.path_cache = &profile_templates[4].path_cache,
			.path_cache_name = &profile_templates[4].path,
		},

		{
			.path_cache = &profile_templates[5].path_cache,
			.path_cache_name = &profile_templates[5].path,
		},

		{
			.path_cache = &profile_templates[6].path_cache,
			.path_cache_name = &profile_templates[6].path,
		},

		{
			.path_cache = &profile_templates[7].path_cache,
			.path_cache_name = &profile_templates[7].path,
		},

		{
			.path_cache = &profile_templates[8].path_cache,
			.path_cache_name = &profile_templates[8].path,
		},

		{
			.path_cache = &profile_templates[9].path_cache,
			.path_cache_name = &profile_templates[9].path,
		},

		{
			.path_cache = &profile_templates[10].path_cache,
			.path_cache_name = &profile_templates[10].path,
		},

		{
			.path_cache = &profile_templates[11].path_cache,
			.path_cache_name = &profile_templates[11].path,
		},

		{
			.path_cache = &profile_templates[12].path_cache,
			.path_cache_name = &profile_templates[12].path,
		},

		{
			.path_cache = &profile_templates[13].path_cache,
			.path_cache_name = &profile_templates[13].path,
		},

		{
			.path_cache = &profile_templates[14].path_cache,
			.path_cache_name = &profile_templates[14].path,
		},

		{
			.path_cache = &profile_templates[15].path_cache,
			.path_cache_name = &profile_templates[15].path,
		},

		{
			.path_cache = &profile_templates[16].path_cache,
			.path_cache_name = &profile_templates[16].path,
		},

		{
			.path_cache = &profile_templates[17].path_cache,
			.path_cache_name = &profile_templates[17].path,
		},

		{
			.path_cache = &profile_templates[18].path_cache,
			.path_cache_name = &profile_templates[18].path,
		},

		{
			.path_cache = &profile_templates[19].path_cache,
			.path_cache_name = &profile_templates[19].path,
		},

		{
			.path_cache = &profile_templates[20].path_cache,
			.path_cache_name = &profile_templates[20].path,
		},

		{
			.path_cache = &profile_templates[21].path_cache,
			.path_cache_name = &profile_templates[21].path,
		},

		{
			.path_cache = &profile_templates[22].path_cache,
			.path_cache_name = &profile_templates[22].path,
		},

		{
			.path_cache = &profile_templates[23].path_cache,
			.path_cache_name = &profile_templates[23].path,
		},

		{
			.path_cache = &profile_templates[24].path_cache,
			.path_cache_name = &profile_templates[24].path,
		},

		{
			.path_cache = &profile_templates[25].path_cache,
			.path_cache_name = &profile_templates[25].path,
		},

		{
			.path_cache = &profile_templates[26].path_cache,
			.path_cache_name = &profile_templates[26].path,
		},

		{
			.path_cache = &profile_templates[27].path_cache,
			.path_cache_name = &profile_templates[27].path,
		},

		{
			.path_cache = &profile_templates[28].path_cache,
			.path_cache_name = &profile_templates[28].path,
		},

		{
			.path_cache = &profile_templates[29].path_cache,
			.path_cache_name = &profile_templates[29].path,
		},

		{
			.path_cache = &profile_templates[30].path_cache,
			.path_cache_name = &profile_templates[30].path,
		},
	}
};
