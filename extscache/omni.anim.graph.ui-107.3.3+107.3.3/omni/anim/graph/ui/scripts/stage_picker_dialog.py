...
class StagePickerDialog:
    def __init__(
        ...
        # workaround for "'StageWidget' object has no attribute '_options_menu_reset'"
        # omni.kit.widget.stage version 2.10.18: stage_widget.py(252): update_filter_menu_state
        self._stage_widget._options_menu_reset = ui.Spacer()
    ...
    def clean(self):
        ...
        self._stage_widget._options_menu_reset = None
        self._stage_widget.open_stage(None)
