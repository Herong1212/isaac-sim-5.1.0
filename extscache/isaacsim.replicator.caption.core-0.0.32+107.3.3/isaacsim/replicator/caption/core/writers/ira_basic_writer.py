"""
Copied from isaacsim.replicator.agent.core.writers.basic_writer
"""
...
from .object_info_manager import ObjectInfoManager
...
class IRABasicWriter(BasicWriter):
    ...
    Inherient from this class if you want to add your writer as a built-in ORA writer.
    """
    ...
    def basic_params_values(cls) -> dict:
        ...
        param_value_dict["output_dir"] = ReplicatorCaptionSettings.get_cache_folder_path()
        param_value_dict["semantic_filter_predicate"] = None
        param_value_dict["semantic_types"] = None
        ...
        param_value_dict["skeleton_data"] = False
    ...
    def extract_object_detection_annotator(cls, param_name: str):
        ...
        annotator_classification_prefix = [
            ReplicatorCaptionSettings.AnnotatorPrefix.ObjectDetection.GENERIC,
            ReplicatorCaptionSettings.AnnotatorPrefix.Others.CUSTOMIZED,
        ]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.skip_frames = 0  # PLACEHOLDER :: skip first n frame
        ...
        if object_detection_info:
            ...
            if agent_info_dict:
                for prim_path, agent_info in agent_info_dict.items():
                    ...
                    info_dict["agents"].append(agent_info.get_all_info())
            ...
            if self.output_objects:
                ...
                for prim_path, object_info in object_info_dict.items():
                    ...
                    info_dict["objects"].append(
                        object_info.get_all_info()
                    )  # TODO: decide whether it's an object or agent
