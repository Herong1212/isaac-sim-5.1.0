...
try:
    import omni.importer.onshape.onshape_client as onshape_client
    from omni.importer.onshape.onshape_client import Client
except ImportError as exc:
    carb.log_error(f"onshape dependencies not found! {exc}")
