...
import pxr
from omni.importer.onshape.scripts import usd_generator
from omni.importer.onshape.widgets import (
    assembly_widget,
    documents_widget,
    elements_widget,
    parts_widget,
...
class TestOnshape(omni.kit.test.AsyncTestCase):
    ...
    async def test_01_load_client(self):
        ...
        omni.importer.onshape.onshape_client

        self.assertIsNotNone(omni.importer.onshape.onshape_client)
        pass

    @unittest.skip("Skipping as this test no longer works after license getting revoked")
    async def test_02_authenticate(self):
        from omni.importer.onshape.client import OnshapeClient
    ...
    async def test_revolute_mate_no_limits_no_offset(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/no_limits_no_offset/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # Check it has the reference
        prim = stage.GetPrimAtPath("/World/no_limits_no_offset/Part_2/Part_2")
        self.assertTrue(prim.IsValid())
        # Check the slider made was build
    ...
    async def test_revolute_mate_no_limits_offset(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/no_limits_offset/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # comment out for now
        # bug: if onshape workspace unit is wrong the import will fail
    ...
    async def test_revolute_mate_no_limits_no_offset_limits_enabled(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/no_limits_no_offset_limits_enabled/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # Check it has the reference
        prim = stage.GetPrimAtPath("/World/no_limits_no_offset_limits_enabled/Part_2/Part_2")
        self.assertTrue(prim.IsValid())
        # Check the slider made was build
    ...
    async def test_revolute_mate_limits_no_offset(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/limits_no_offset/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # Check it has the reference
        prim = stage.GetPrimAtPath("/World/limits_no_offset/Part_2/Part_2")
        self.assertTrue(prim.IsValid())
        # Check the slider made was build
    ...
    async def test_revolute_mate_low_limit_no_offset(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/low_limit_no_offset/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # Check it has the reference
        prim = stage.GetPrimAtPath("/World/low_limit_no_offset/Part_2/Part_2")
        self.assertTrue(prim.IsValid())
        # Check the slider made was build
    ...
    async def test_revolute_mate_high_limit_no_offset(self):
        ...
        stage = self.usd_gen.assembly_stage
        # Check prim was made
        prim = stage.GetPrimAtPath("/World/high_limit_no_offset/Part_2")
        self.assertTrue(prim.IsValid())
        ...
        # Check it has the reference
        prim = stage.GetPrimAtPath("/World/high_limit_no_offset/Part_2/Part_2")
        self.assertTrue(prim.IsValid())
        # Check the slider made was build
