.. _omni_sensors_nv_camera_CamIspDecompandingTaskNode_1:

.. _omni_sensors_nv_camera_CamIspDecompandingTaskNode:
...
.. meta::
    :title: Cam Isp Decompanding Task Node
    :keywords: lang-en omnigraph node camera cam-isp-decompanding-task-node


Cam Isp Decompanding Task Node
==============================
...
.. csv-table::
    ...
    "Convert To16bit (*inputs:ConvertTo16bit*)", "``bool``", "The IspRGGBDemosaicing works only with uint16, the standard out is uint32 bit", "True"
...
.. csv-table::
    ...
    "Unique ID", "omni.sensors.nv.camera.CamIspDecompandingTaskNode"
    "Version", "1"
    ...
    "Generated Class Name", "CamIspDecompandingTaskNodeDatabase"
