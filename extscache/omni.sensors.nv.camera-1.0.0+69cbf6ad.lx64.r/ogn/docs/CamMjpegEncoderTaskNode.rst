.. _omni_sensors_nv_camera_CamMjpegEncoderTaskNode_1:

.. _omni_sensors_nv_camera_CamMjpegEncoderTaskNode:
...
.. meta::
    :title: Cam Mjpeg Encoder Task Node
    :keywords: lang-en omnigraph node camera cam-mjpeg-encoder-task-node


Cam Mjpeg Encoder Task Node
===========================
...
.. csv-table::
    ...
    "Encoding Profile (*inputs:encodingProfile*)", "``token``", "Compression algorithm: Could be BASELINE or PROGRESSIVE", "BASELINE"
    ...
    "Quality Profile (*inputs:qualityProfile*)", "``int``", "Compression algorithm: Could be AVC, AVC_LOSSY or HEVC", "70"
...
.. csv-table::
    ...
    "Unique ID", "omni.sensors.nv.camera.CamMjpegEncoderTaskNode"
    "Version", "1"
    ...
    "Generated Class Name", "CamMjpegEncoderTaskNodeDatabase"
