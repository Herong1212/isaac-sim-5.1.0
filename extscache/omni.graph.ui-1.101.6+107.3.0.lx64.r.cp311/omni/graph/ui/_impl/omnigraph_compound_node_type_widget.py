...
class OmniGraphCompoundNodeTypePropertiesWidget(SchemaPropertiesWidget):
    ...
    def __init__(self, title: str):
        # newer versions of the schema will get automatically upgraded
        schema_to_use = OmniGraphSchema.OmniGraphCompoundNodeType
        if hasattr(OmniGraphSchema, "CompoundNodeType_1"):
            schema_to_use = OmniGraphSchema.CompoundNodeType_1
        super().__init__(title, schema=schema_to_use, include_inherited=True)
