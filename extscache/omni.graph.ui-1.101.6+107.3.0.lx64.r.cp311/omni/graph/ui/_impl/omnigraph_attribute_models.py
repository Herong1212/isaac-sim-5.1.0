...
class OmniGraphTfTokenAttributeModel(ui.AbstractItemModel, OmniGraphBase):
    ...
    def begin_edit(self, item):  # noqa: PLW0221  FIXME: reconcile with base class calls; pragma: no cover
        OmniGraphBase.begin_edit(self)

    def end_edit(self, item):  # noqa: PLW0221  FIXME: reconcile with base class calls; pragma: no cover
        OmniGraphBase.end_edit(self)
