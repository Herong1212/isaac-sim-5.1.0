"""Custom property panel layout for omni.graph.scriptnode"""
...
EXT_PATH = omni.kit.app.get_app().get_extension_manager().get_extension_path_by_module("omni.graph.scriptnode")
            ...
            with ui.VStack(spacing=10):
                ...
                with ui.HStack(height=0):
                    ...
                    self.attribute_name_field = ui.StringField(
                        width=input_field_width, height=20, identifier="_scriptnode_name"
                    )
...
class CustomLayout:
    ...
    def _script_textbox_build_fn(self, ui_prop: UsdPropertyUiEntry, *args) -> ui.AbstractValueModel:
        ...
        return self.script_textbox_model
    ...
    def _reset_button_build_fn(self, *args):
        ...
        def do_reset():
            ...
            OgnScriptNodeDatabase.NODE_TYPE_CLASS.try_cleanup(self.node)

        ui.Button(
            "Reload Script",
            identifier="_scriptnode_reset",
            clicked_fn=do_reset,
    ...
    def _add_attribute_button_build_fn(self, *args):
        ...
        self.add_attribute_button = ui.Button(
            "Add Attribute...",
            identifier="_scriptnode_add_attribute",
    ...
    def _remove_attribute_button_build_fn(self, *args):
        ...
        self.remove_attribute_button = ui.Button(
            "Remove Attribute...",
            identifier="_scriptnode_remove_attribute",
    ...
    def _script_path_build_fn(self, ui_prop: UsdPropertyUiEntry, *args) -> ui.AbstractValueModel:
    ...
    def _use_path_build_fn(self, ui_prop: UsdPropertyUiEntry, *args) -> ui.AbstractValueModel:
        ...
        def _build_reset(self, *args):
            ...
            with ui.HStack():
                ...
                self.code_snippets_button = ui.Button(
                    "Code Snippets...",
                    identifier="_scriptnode_snippets",
