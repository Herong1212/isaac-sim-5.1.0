.. _omni_graph_scriptnode_ScriptNode_2:
...
.. tab-set::
    ...
    .. tab-item:: Graph Editor
       ...
       .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeGraphMenu.png
            :alt: The graph being created

       Create a new |actiongraph| to hold the script node

       .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeGraphCreate.png
            :alt: The graph being created

      Drag the script node icon from the navigation bar on the left onto the newly created graph

       .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeCreate.png
    ...
    .. tab-item:: Python Code
        ...
        .. literalinclude:: ../../../../../source/extensions/omni.graph.scriptnode/python/tests/test_scriptnode.py
            :language: python
...
.. tab-set::
    ...
    .. tab-item:: Graph Editor
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodePropertyPanelMenu.png
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodePropertyPanel.png
            :alt: The graph being created

        Here is the full text of the instructions:

        .. literalinclude:: ../../../../../source/extensions/omni.graph.scriptnode/python/_impl/scriptnode_example_scripts.py
            :language: python
...
.. tab-set::
    ...
    .. tab-item:: Graph Editor
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeAsFile.png
...
.. tab-set::
    ...
    .. tab-item:: Graph Editor
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeAddingAttributes.png
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeAddInput.png
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeAddOutput.png
        ...
        .. image:: ../../../../../source/extensions/omni.graph.scriptnode/python/nodes/images/ScriptNodeFinalNode.png
...
The script node, accessible when you load the extension :ref:`omni.graph.scriptnode<ext_omni_graph_scriptnode>`,
