...
def generate_service(json_path: str, output_path: str, data_templates: str = None):
    ...
    for interface in spec.interfaces.values():
        ...
        render_interface(interface, dependencies, output_path, renderer)

    print(f"Done. Service is available in {output_path}")


def render_interface(interface, dependencies, output_path, renderer):
