...
if __name__ == "__main__":
    ...
    class TestFlatten(ut.TestCase):
        def test_valid_iterables(self):
            for test_iterable, flattened in [
                ...
                (
                    [("x", 2), {"y": 3, "z": 5}, ((("p", 6), ("a", 5)), ("s", 100))],
                    [("x", 2), ("y", 3), ("z", 5), ("p", 6), ("a", 5), ("s", 100)],
                ),
                (
                    [[({"x": 2}, {"y": {"x": 1}})], ({"1": 2, "z": 4}, ("p", 90))],
                    [("x", 2), ("y", {"x": 1}), ("1", 2), ("z", 4), ("p", 90)],
                ),
                ((((((((({"x": 2}))))), ("y", 3)))), [("x", 2), ("y", 3)]),
            ]:
                self.assertEqual(list(_flatten(test_iterable)), flattened)
    ...
    class TestSafeEval(ut.TestCase):
        ...
        def test_arithmetic_expressions(self):
            ...
            # math
            self.assertEqual(
                safe_eval("math.sin(a) + math.cos(b) - math.pow(1,2)", {"a": 123, "b": 321}),
                math.sin(123) + math.cos(321) - math.pow(1, 2),
            )
            self.assertEqual(safe_eval("123 ** math.sin(math.cos(a))", {"a": 56}), 123 ** math.sin(math.cos(56)))
            self.assertEqual(
                safe_eval(
                    "g ** math.sin(math.cos(a+b)) // math.pi",
