...
from .constant import COLORS, DarkColors, LightColors, MouseKey
...
class DashButton:
    ...
    @property
    def enabled(self):
        return self._rectangle.enabled

    @enabled.setter
    def enabled(self, value):
        self._rectangle.enabled = value
...
class ImageButton:
    ...
    def enable(self, enabled):
        if self._enabled != enabled:
            ...
            self._bkground_widget.enabled = enabled
...
class SimpleImageButton(ImageButton):
    ...
    @clicked_fn.setter
    def clicked_fn(self, fn):
        self._on_clicked_fn = fn
