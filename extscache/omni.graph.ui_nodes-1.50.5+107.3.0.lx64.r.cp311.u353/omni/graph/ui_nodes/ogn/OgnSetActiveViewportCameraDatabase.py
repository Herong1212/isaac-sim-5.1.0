r"""Support for simplified access to data on nodes of type omni.graph.ui_nodes.SetActiveViewportCamera
...
class OgnSetActiveViewportCameraDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type omni.graph.ui_nodes.SetActiveViewportCamera
    ...
    INTERFACE = og.Database._get_interface([
        ('inputs:execIn', 'execution', 0, 'In', 'Signal to the graph that this node is ready to be executed.', {}, True, None, False, ''),
        ...
        ('outputs:execOut', 'execution', 0, 'Out', 'Signal to the graph that execution can continue downstream.', {}, True, None, False, ''),
    ])
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'omni.graph.ui_nodes.SetActiveViewportCamera'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnSetActiveViewportCameraDatabase.abi.initialize(context, n)
        ...
        def init_instance(node, graph_instance_id):
            init_instance_function = getattr(OgnSetActiveViewportCameraDatabase.NODE_TYPE_CLASS, 'init_instance', None)
            if callable(init_instance_function):  # pragma: no cover
                init_instance_function(node, graph_instance_id)

        @staticmethod
        def release_instance(node, graph_instance_id):
            release_instance_function = getattr(OgnSetActiveViewportCameraDatabase.NODE_TYPE_CLASS, 'release_instance', None)
            if callable(release_instance_function):  # pragma: no cover
                release_instance_function(node, graph_instance_id)
            OgnSetActiveViewportCameraDatabase._release_per_node_instance_data(node, graph_instance_id)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                if __hints is not None:
                    __hints.set_data_access(og.eAccessLocation.E_USD, og.eAccessType.E_READ)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("omni.graph.ui_nodes.SetActiveViewportCamera")
