r"""Support for simplified access to data on nodes of type omni.graph.ui_nodes.OnNewFrame
...
class OgnOnNewFrameDatabase(og.Database):
    """Helper class providing simplified access to data on nodes of type omni.graph.ui_nodes.OnNewFrame
    ...
    class abi:
        ...
        def get_node_type():
            ...
            return 'omni.graph.ui_nodes.OnNewFrame'
        ...
        def initialize_nodes(context, nodes):
            for n in nodes:
                OgnOnNewFrameDatabase.abi.initialize(context, n)
        ...
        def init_instance(node, graph_instance_id):
            init_instance_function = getattr(OgnOnNewFrameDatabase.NODE_TYPE_CLASS, 'init_instance', None)
            if callable(init_instance_function):  # pragma: no cover
                init_instance_function(node, graph_instance_id)

        @staticmethod
        def release_instance(node, graph_instance_id):
            release_instance_function = getattr(OgnOnNewFrameDatabase.NODE_TYPE_CLASS, 'release_instance', None)
            if callable(release_instance_function):  # pragma: no cover
                release_instance_function(node, graph_instance_id)
            OgnOnNewFrameDatabase._release_per_node_instance_data(node, graph_instance_id)
    ...
    @staticmethod
    def deregister():
        og.deregister_node_type("omni.graph.ui_nodes.OnNewFrame")
