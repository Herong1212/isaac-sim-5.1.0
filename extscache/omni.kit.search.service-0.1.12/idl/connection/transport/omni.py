...
from idl.data.serializers.omni_json import OmniJSONSerializer
...
class OmniClientTransport(Client):
    ...
    def __init__(self, url: str, *, max_size: int = MAX_SIZE,
                 ssl_context: ssl.SSLContext = None, extra_headers=None, **kwargs):
        """
        ...
        :param extra_headers: HTTP headers to add to the request. `websockets.connect`.
        """
        self.url = url
        ...
        self.marshaller = Marshaller(OmniJSONSerializer())
    ...
    async def prepare(self):
        ...
        try:
            self.ws = await websockets.connect(self.url,
                                               ...
                                               ping_interval=self.ping_interval, extra_headers=self.extra_headers)
