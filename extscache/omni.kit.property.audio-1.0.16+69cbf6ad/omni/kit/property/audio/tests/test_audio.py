...
class TestAudioWidget(OmniUiTest):  # pragma: no cover
    ...
    async def test_sound_ui(self):
        ...
        await self.finalize_test(
            golden_img_dir=self._golden_img_dir, golden_img_name="test_sound_ui.png", zero_mouse=True
        )
    ...
    async def test_listener_ui(self):
        ...
        await self.finalize_test(
            golden_img_dir=self._golden_img_dir, golden_img_name="test_listener_ui.png", zero_mouse=True
        )
