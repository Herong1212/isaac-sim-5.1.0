...
from ..widgets import TreeFolderBrowserWidget
from .browser_property_delegate import BrowserPropertyDelegate
from .browser_property_toolbar import BrowserPropertyToolBar
from .browser_property_view import BrowserPropertyView
from .style import PROPERTY_STYLES


# Layout are dynamic changed when window size changed: small to V mode otherwise to H mode
# V mode: property view under detail view
# H mode: property view right at detail view
class Layout:
...
class TreeFolderBrowserWidgetEx(TreeFolderBrowserWidget):
    ...
    def __init__(self, *args, property_delegates: List[BrowserPropertyDelegate] = [], **kwargs):
        self._frame_width: Optional[float] = None
        self._frame_height: Optional[float] = None
        self._propert_delegates = property_delegates
    ...
    def build_widgets(self) -> None:
        ...
        with self._frame:
            with ui.VStack(spacing=4, style=PROPERTY_STYLES):
    ...
    def build_property_view(self) ->BrowserPropertyView:
        ...
        Build property view.
        """
        return BrowserPropertyView(self._propert_delegates, style=self._extra_ui_style)
    ...
    def _build_browser_widgets(self):
        ...
        with self._browser_container:
            ...
            with self._toolkits_container:
                ...
                # Property View
                self._property_view = self.build_property_view()
        ...
        self._on_detail_selection_changed(self._browser_widget._detail_view.selection)
    ...
    def _on_detail_selection_changed(self, selections: List[FileDetailItem]) -> None:
        ...
        self._property_view.show(selections)
