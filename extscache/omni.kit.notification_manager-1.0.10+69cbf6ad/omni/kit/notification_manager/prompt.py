...
class Prompt:
    ...
    async def docking_to(self, window_x, window_y, window_width, window_height, offset_y=0) -> bool:
        ...
        if self._window is None:
            # Have to check again because the window may be destroyed when docking
            return False
