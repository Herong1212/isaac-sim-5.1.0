...
class AssetLoadStatus():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    DONE: omni.usd.audio._audio.AssetLoadStatus # value = <AssetLoadStatus.DONE: 0>
    FAILED: omni.usd.audio._audio.AssetLoadStatus # value = <AssetLoadStatus.FAILED: 2>
    IN_PROGRESS: omni.usd.audio._audio.AssetLoadStatus # value = <AssetLoadStatus.IN_PROGRESS: 1>
    NOT_REGISTERED: omni.usd.audio._audio.AssetLoadStatus # value = <AssetLoadStatus.NOT_REGISTERED: 3>
    __members__: dict # value = {'IN_PROGRESS': <AssetLoadStatus.IN_PROGRESS: 1>, 'DONE': <AssetLoadStatus.DONE: 0>, 'FAILED': <AssetLoadStatus.FAILED: 2>, 'NOT_REGISTERED': <AssetLoadStatus.NOT_REGISTERED: 3>}
    pass
class EventType():
    """
    Members:
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    ACTIVE_LISTENER_CHANGE: omni.usd.audio._audio.EventType # value = <EventType.ACTIVE_LISTENER_CHANGE: 3>
    LISTENER_LIST_CHANGE: omni.usd.audio._audio.EventType # value = <EventType.LISTENER_LIST_CHANGE: 2>
    METADATA_CHANGE: omni.usd.audio._audio.EventType # value = <EventType.METADATA_CHANGE: 1>
    __members__: dict # value = {'METADATA_CHANGE': <EventType.METADATA_CHANGE: 1>, 'LISTENER_LIST_CHANGE': <EventType.LISTENER_LIST_CHANGE: 2>, 'ACTIVE_LISTENER_CHANGE': <EventType.ACTIVE_LISTENER_CHANGE: 3>}
    pass
class FeatureDefault():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    FORCE_OFF: omni.usd.audio._audio.FeatureDefault # value = <FeatureDefault.FORCE_OFF: 3>
    FORCE_ON: omni.usd.audio._audio.FeatureDefault # value = <FeatureDefault.FORCE_ON: 2>
    OFF: omni.usd.audio._audio.FeatureDefault # value = <FeatureDefault.OFF: 1>
    ON: omni.usd.audio._audio.FeatureDefault # value = <FeatureDefault.ON: 0>
    __members__: dict # value = {'ON': <FeatureDefault.ON: 0>, 'OFF': <FeatureDefault.OFF: 1>, 'FORCE_ON': <FeatureDefault.FORCE_ON: 2>, 'FORCE_OFF': <FeatureDefault.FORCE_OFF: 3>}
    pass
class SoundLengthType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    ASSET_LENGTH: omni.usd.audio._audio.SoundLengthType # value = <SoundLengthType.ASSET_LENGTH: 2>
    PLAY_LENGTH: omni.usd.audio._audio.SoundLengthType # value = <SoundLengthType.PLAY_LENGTH: 0>
    SOUND_LENGTH: omni.usd.audio._audio.SoundLengthType # value = <SoundLengthType.SOUND_LENGTH: 1>
    __members__: dict # value = {'PLAY_LENGTH': <SoundLengthType.PLAY_LENGTH: 0>, 'SOUND_LENGTH': <SoundLengthType.SOUND_LENGTH: 1>, 'ASSET_LENGTH': <SoundLengthType.ASSET_LENGTH: 2>}
    pass
