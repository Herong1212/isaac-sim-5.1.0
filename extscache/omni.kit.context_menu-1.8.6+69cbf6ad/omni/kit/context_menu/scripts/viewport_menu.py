...
class ViewportMenu:
    ...
    class ViewportMenuDelegate(DefaultMenuDelegate):
         def get_style(self):
            return super().get_style() | MENU_STYLE


    menu_delegate = ViewportMenuDelegate()
    ...
    def show_create_menu(objects):
        ...
        get_instance().build_create_menu(
            objects,
            prim_list,
            omni.kit.context_menu.get_menu_dict("CREATE", "omni.kit.viewport.window"),
            delegate=ViewportMenu.menu_delegate
        )
        get_instance().build_add_menu(
            objects, prim_list, omni.kit.context_menu.get_menu_dict("ADD", "omni.kit.viewport.window")
        )
    ...
    def show_menu(usd_context_name: str, prim_path: str = None, world_pos: Sequence[float] = None, stage=None):
        ...
        menu_dict += omni.kit.context_menu.get_menu_dict("MENU", "omni.kit.viewport.window")
